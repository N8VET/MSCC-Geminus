       ...
       public void Open_Relay_Board()
        ...
        public void LogWrite(string logMessage)
        {
            ...
            catch (Exception)
            {
                ...
                {
                    MessageBox.Show("LogWrite -> Log File Write FAILED", "MSCC",
    ...
    if (timer_status == false)
    {
        ...
        private void Frm_state(object sender, EventArgs e)
        {
            if (this.WindowState != LastWindowState)
            {
                ...
                {
                    oCode.SendCommand(txsocket, txtarget, Solidus_Settings.CMD_SET_DISPLAY_MODE, 1);
                    MonitorTextBoxText(" Frm_state Called State: " + this.WindowState);
                }
                else if (this.WindowState == FormWindowState.Normal)
                {
                    oCode.SendCommand(txsocket, txtarget, Solidus_Settings.CMD_SET_DISPLAY_MODE, 0);
                    MonitorTextBoxText(" Frm_state Called State: " + this.WindowState);
        ...
        public void Initialize_RIT()
        {
            ...
            switch (Rit_Controls.RIT_Step_Index)
            {
                case 0:
            ...
            ritlistBox1.SetSelected(Rit_Controls.RIT_Step_Index, true);
#if FTDI
        ...
        public void Set_Button_Color(bool active, Button mybutton)
        {
            ...
            {
                case true:
                    mybutton.BackColor = Master_Controls.Display_Colors.Button_Active_Background;
                    mybutton.ForeColor = Master_Controls.Display_Colors.Button_Active_Foreground;
                    mybutton.Font = new Font(mybutton.Font, FontStyle.Bold);
                    break;
                default:
                    mybutton.ForeColor = Master_Controls.Display_Colors.Default_Foreground;
                    mybutton.BackColor = Master_Controls.Display_Colors.Default_Background;
                    mybutton.Font = new Font(mybutton.Font, FontStyle.Regular);
                    break;
            }
        }
        public void Set_Button_Color(bool active, Button mybutton,String text)
        {
            switch (active)
            {
                case true:
        ...
        public void Set_Textbox_Color(bool active, TextBox mytext)
        {
            switch (active)
            {
                case true:
                ...
                default:
                    ...
                    mytext.BackColor = Color.Gainsboro;
                    break;
            }
        }
        public void Set_Warning_Label_Color(bool active, System.Windows.Forms.Label mylabel)
        {
            switch (active)
            {
                case true:
                ...
                default:
                    ...
                    mylabel.BackColor = Color.Gainsboro;
                    break;
            }
        }
        ...
        public void Manage_RPI_Controls()
        {
            ...
            if (Rit_Controls.Previous_Rit_Offset_From_Server != Rit_Controls.RIT_Offset_From_Server)
            {
                Manage_Rit_From_Server();
                Rit_Controls.Previous_Rit_Offset_From_Server = Rit_Controls.RIT_Offset_From_Server;
            }
            ritScroll.Enabled = Rit_Controls.RIT_Scroll_Bar_Status;

            if (Solidus_Settings.Volume_Settings.Set_By_Server)
            {
                MonitorTextBoxText(" Manage_RPI_Controls -> Solidus_Settings.Volume_Settings.Set_By_Server. Mode: " +
                        Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Is_Digital));
                if (Settings.Default.Speaker_MutED)
                {
                    ...
                    Solidus_Settings.Volume_Settings.Speaker_Mute = 0;
                }

                if (!Solidus_Settings.Volume_Settings.Mic_Is_Digital)
                {
                    Volume_hScrollBar1.Value = Solidus_Settings.Volume_Settings.Speaker_Voice_Volume;
                    Volume_textBox2.Text = Convert.ToString(Solidus_Settings.Volume_Settings.Speaker_Voice_Volume);
                }
                else
                {
                    Volume_hScrollBar1.Value = Solidus_Settings.Volume_Settings.Speaker_Volume;
                    Volume_textBox2.Text = Convert.ToString(Solidus_Settings.Volume_Settings.Speaker_Volume);
                }
                Solidus_Settings.Volume_Settings.Previous_Speaker_Volume = Solidus_Settings.Volume_Settings.Master_Speaker_Volume;
                Solidus_Settings.Volume_Settings.Set_By_Server = false;
            }

            if (Solidus_Settings.Previous_Freq_Step != Solidus_Settings.Freq_Step)
            {
                Master_Controls.Step_Index = Solidus_Settings.Freq_Step;
                Solidus_Settings.Previous_Freq_Step = Solidus_Settings.Freq_Step;
            }

            if (Solidus_Settings.Freq_Digit != oCode.FreqDigit)
            {
                ...
                oCode.SendCommand_MultiByte(txsocket, txtarget, Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND,
                                                                        buf, buf.Length);
                Solidus_Settings.Freq_Digit = oCode.FreqDigit;
            }
            ...
            if (Solidus_Settings.Amplifier_Values.Previous_Power_Output != Solidus_Settings.Amplifier_Values.Power_Output)
            {
                Solidus_Settings.Amplifier_Values.Previous_Power_Output = Solidus_Settings.Amplifier_Values.Power_Output;
            }

            if (Solidus_Settings.Amplifier_Values.Previous_Power_Calibration !=
                                                    Solidus_Settings.Amplifier_Values.Power_Calibration)
            {
               Solidus_Settings.Amplifier_Values.Previous_Power_Calibration =
                                                    Solidus_Settings.Amplifier_Values.Power_Calibration;
            }

            if (Filter_control.Previous_Filter_High_Index != Filter_control.Filter_High_Index)
            {
                Display_High_Cut_Value();
            ...
            if (Default_Filters_Configured)
            {
                Default_Filters_Configured = false;
                Filter_control.Filter_High_Index = (short)Settings.Default.Hi_Cut_Default;
                Filter_control.Filter_Low_Index = (short)Settings.Default.Lo_Cut_Default;
                Filter_control.CW_Filter_Index = (short)Settings.Default.CW_Default;
                MonitorTextBoxText(" Manage_RPI_Controls -> Default_Filters_Configured");
            }
        ...
        public bool Update_RPi_Settings()
        {
            ...
            file.WriteLine("MIC_DIGITAL_VOLUME=" + Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Digital_Volume) + ";");
            file.WriteLine("MIC_VOICE_VOLUME=" + Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Voice_Volume) + ";");
            ...
            file.WriteLine("RIT_STEP=" + Convert.ToString(Rit_Controls.RIT_Step_Index) + ";");
            file.WriteLine("PEAK_NEEDLE=" + Convert.ToString(Solidus_Settings.Peak_Needle) + ";");
            file.WriteLine("PEAK_NEEDLE_DELAY_INDEX=" + Convert.ToString(Solidus_Settings.Peak_Needle_Delay_Index) + ";");
            file.WriteLine("PEAK_NEEDLE_COLOR_INDEX=" + Convert.ToString(Solidus_Settings.Peak_Needle_Color_Index) + ";");
            file.WriteLine("TIME_DISPLAY=" + Convert.ToString(Solidus_Settings.Time_Display) + ";");
            file.WriteLine("METER_MODE=" + Convert.ToString(Solidus_Settings.Meter_Mode) + ";");
            file.WriteLine("SPEAKER_ATTN=" + Convert.ToString(Solidus_Settings.Volume_Settings.Volume_ATTN_Index) + ";");
            file.WriteLine("DIGITAL_SPEAKER_ATTN=" + Convert.ToString(Solidus_Settings.Volume_Settings.Digital_Volume_ATTN_index) + ";");
            file.WriteLine("SPEAKER_VOLUME=" + Convert.ToString(Solidus_Settings.Volume_Settings.Speaker_Volume) + ";");
            file.WriteLine("SPEAKER_MUTE=" + Convert.ToString(Solidus_Settings.Volume_Settings.Speaker_Mute) + ";");
            file.WriteLine("SPEAKER_VOICE_VOLUME=" + Convert.ToString(Solidus_Settings.Volume_Settings.Speaker_Voice_Volume) + ";");
            file.WriteLine("MIC_VOLUME=" + Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Volume) + ";");
            file.WriteLine("MIC_MUTE=" + Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Mute) + ";");
            file.WriteLine("MIC_PRE_GAIN=" + Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Pre_Gain) + ";");
            file.WriteLine("ANTENNA_SWITCH=" + Convert.ToString(Solidus_Settings.Antenna_Switch) + ";");
            file.WriteLine("SHUTDOWN=" + Convert.ToString(Solidus_Settings.Shutdown) + ";");
            ...
            file.WriteLine("METER_HOLD=" + Convert.ToString(Solidus_Settings.Meter_Hold) + ";");
            file.WriteLine("QRP_TUNE_POWER=" + Convert.ToString(Solidus_Settings.QRP_Tune_Power) + ";");
            file.WriteLine("BAND_CHANGE_TUNE=" + Convert.ToString(Solidus_Settings.Band_Change_Tune) + ";");
            file.WriteLine("SMETER_COLOR=" + Convert.ToString(Solidus_Settings.Meter_Background_Color_Index) + ";");
            file.WriteLine("FREQ_CALIBRATED=" + Convert.ToString(Frequency_Calibration_controls.Frequency_Calibrated) + ";");
            file.WriteLine("AUTO_ZERO=" + Convert.ToString(Solidus_Settings.Auto_Zero) + ";");
            ...
            file.WriteLine("MIC_MODE=" + Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Mode) + ";");

            file.Flush();
            file.Close();
            //Solidus_Settings.RPi_Needs_Updated = false;
            return true;
        }
        public bool Init_CW_Settings()
        {
            int temp = 0;
            MonitorTextBoxText(" Init_CW_Settings Called");
#if RPI 
            oCode.Get_CW_Params();
#endif
            ...
            temp = CW_Parameters.CW_Spacing - 1;
            if(temp < 0)
            {
                temp = 0;
            }
            CW_Space_listBox1.SelectedIndex = temp;
            ...
            oCode.SendCommand(txsocket, txtarget, oCode.SET_SIDE_TONE_VOLUME, CW_Parameters.CW_Side_Tone_Volume);
            numericUpDown1.Value = CW_Parameters.CW_Speed;
            CW_Lag_numericUpDown2.Value = CW_Parameters.CW_Lag;
            ...
            semicheckBox2.CheckedChanged += semicheckBox2_CheckedChanged;
            oCode.SendCommand(txsocket, txtarget, oCode.SET_SEMI_BREAKIN, CW_Parameters.CW_Semi_Break_In);
            MonitorTextBoxText(" Init_CW_Settings Finished");
            return true;
        }
        public bool Proficio_Check_Calibrated_Bands()
        {
            bool status = true;
            
            if(Power_Calibration_Controls.Calibrated_Bands.B_160 == 0)
            {
                status = false;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_80 == 0)
            {
                status = false;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_60 == 0)
            {
                status = false;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_40 == 0)
            {
                status = false;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_30 == 0)
            {
                status = false;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_20 == 0)
            {
                status = false;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_17 == 0)
            {
                status = false;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_15 == 0)
            {
                status = false;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_12 == 0)
            {
                status = false;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_10 == 0)
            {
                status = false;
            }
            return status;
        ...
        public bool Init_RPi_Settings()
        {
            ...
            {
                line_count++;
                //Smeter_controls.Smeter_Average
                temp_string = getBetween(line, "PROFICIO_B160=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Power_Calibration_Controls.Calibrated_Bands.B_160 = (byte)temp_int;             
                    Message = " PROFICIO_B160: " + Convert.ToString(Power_Calibration_Controls.Calibrated_Bands.B_160);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "PROFICIO_B80=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Power_Calibration_Controls.Calibrated_Bands.B_80 = (byte)temp_int;
                    Message = " PROFICIO_B80: " + Convert.ToString(Power_Calibration_Controls.Calibrated_Bands.B_80);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "PROFICIO_B60=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Power_Calibration_Controls.Calibrated_Bands.B_60 = (byte)temp_int;
                    Message = " PROFICIO_B60: " + Convert.ToString(Power_Calibration_Controls.Calibrated_Bands.B_60);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "PROFICIO_B40=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Power_Calibration_Controls.Calibrated_Bands.B_40 = (byte)temp_int;
                    Message = " PROFICIO_B40: " + Convert.ToString(Power_Calibration_Controls.Calibrated_Bands.B_40);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "PROFICIO_B30=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Power_Calibration_Controls.Calibrated_Bands.B_30 = (byte)temp_int;
                    Message = " PROFICIO_B30: " + Convert.ToString(Power_Calibration_Controls.Calibrated_Bands.B_30);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "PROFICIO_B20=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Power_Calibration_Controls.Calibrated_Bands.B_20 = (byte)temp_int;
                    Message = " PROFICIO_B20: " + Convert.ToString(Power_Calibration_Controls.Calibrated_Bands.B_20);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "PROFICIO_B17=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Power_Calibration_Controls.Calibrated_Bands.B_17 = (byte)temp_int;
                    Message = " PROFICIO_B17: " + Convert.ToString(Power_Calibration_Controls.Calibrated_Bands.B_17);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "PROFICIO_B15=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Power_Calibration_Controls.Calibrated_Bands.B_15 = (byte)temp_int;
                    Message = " PROFICIO_B15: " + Convert.ToString(Power_Calibration_Controls.Calibrated_Bands.B_15);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "PROFICIO_B12=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Power_Calibration_Controls.Calibrated_Bands.B_12 = (byte)temp_int;
                    Message = " PROFICIO_B12: " + Convert.ToString(Power_Calibration_Controls.Calibrated_Bands.B_12);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "PROFICIO_B10=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Power_Calibration_Controls.Calibrated_Bands.B_10 = (byte)temp_int;
                    Message = " PROFICIO_B10: " + Convert.ToString(Power_Calibration_Controls.Calibrated_Bands.B_10);
                    Write_Debug_Message(Message);
                }
              
                temp_string = getBetween(line, "ALC_MULTIPLIER=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    AGC_ALC_Notch_Controls.ALC_Value = temp_int;
                    oCode.SendCommand(txsocket, txtarget, AGC_ALC_Notch_Controls.CMD_SET_ALC_MULTIPLIER,
                                                                    (short)AGC_ALC_Notch_Controls.ALC_Value);
                    Message = " ALC_MULTIPLIER: " + Convert.ToString(AGC_ALC_Notch_Controls.ALC_Value);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "FREQ_CALIBRATED=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Frequency_Calibration_controls.Frequency_Calibrated = temp_int;
                    Message = " FREQ_CALIBRATED: " + Convert.ToString(Frequency_Calibration_controls.Frequency_Calibrated);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "RIT_STEP=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Rit_Controls.RIT_Step_Index = temp_int;
                    Message = " RIT_STEP: " + Convert.ToString(Rit_Controls.RIT_Step_Index);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "1_SMETER_AVERAGE=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Smeter_controls.Smeter_Average = (byte)temp_int;
                    switch (Smeter_controls.Smeter_Average)
                    {
                        case 0:
                            Smeter_Average_button8.Text = "5";
                            break;
                        case 1:
                            Smeter_Average_button8.Text = "10";
                            break;
                        case 2:
                            Smeter_Average_button8.Text = "15";
                            break;
                        case 3:
                            Smeter_Average_button8.Text = "20";
                            break;
                    }
                    Message = " 1_SMETER_AVERAGE: " + Convert.ToString(Smeter_controls.Smeter_Average);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "AUTO_ZERO=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Auto_Zero = temp_int;
                    switch (Solidus_Settings.Auto_Zero)
                    {
                        case 0:
                    ...
                    Message = " AUTO_ZERO: " + Convert.ToString(Solidus_Settings.Auto_Zero);
                    Write_Debug_Message(Message);
                }
                ...
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Antenna_Switch = temp_int;
                    Settings.Default.Antenna_Switch = (byte)temp_int;
                    switch (Solidus_Settings.Antenna_Switch)
                    {
                        case 0:
                            Antenna_Switch_button8.Text = "160M";
                            break;
                        case 1:
                            Antenna_Switch_button8.Text = "80M";
                            break;
                        case 2:
                            Antenna_Switch_button8.Text = "60M";
                            break;
                        case 3:
                            Antenna_Switch_button8.Text = "40M";
                            break;
                        case 4:
                            Antenna_Switch_button8.Text = "30M";
                            break;
                        case 5:
                            Antenna_Switch_button8.Text = "20M";
                            break;
                        case 6:
                            Antenna_Switch_button8.Text = "17M";
                            break;
                        case 7:
                            Antenna_Switch_button8.Text = "15M";
                            break;
                        case 8:
                            Antenna_Switch_button8.Text = "12M";
                            break;
                        case 9:
                            Antenna_Switch_button8.Text = "10M";
                            break;
                    }
                    buf[0] = Master_Controls.Extended_Commands.CMD_SET_ANTENNA_SWITCH;
                    buf[1] = Set_Antenna_Switch_Value(Solidus_Settings.Antenna_Switch);
                    oCode.SendCommand_MultiByte(txsocket, txtarget,
                          Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND, buf, buf.Length);
                    Message = " ANTENNA_SWITCH: " + Convert.ToString(buf[1]);
                    Write_Debug_Message(Message);
                }
                ...
                if (temp_string != "")
                {
                    volume_count++;
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Volume_Settings.Speaker_Volume = temp_int;
                    Solidus_Settings.Volume_Settings.Previous_Speaker_Volume = temp_int;
                    Message = " SPEAKER_VOLUME: " + Convert.ToString(Solidus_Settings.Volume_Settings.Speaker_Volume);
                    Write_Debug_Message(Message);
                    Message = " SPEAKER_VOLUME Count: " + Convert.ToString(volume_count);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "SPEAKER_VOICE_VOLUME=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Volume_Settings.Speaker_Voice_Volume = temp_int;
                    Message = " SPEAKER_VOICE_VOLUME: " + Convert.ToString(Solidus_Settings.Volume_Settings.Speaker_Voice_Volume);
                    Write_Debug_Message(Message);
                }
                ...
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Volume_Settings.Volume_ATTN_Index = temp_int;
                    Volume_Attn_button8.Text = Convert.ToString(Solidus_Settings.Volume_Settings.Volume_ATTN_Index);
                    oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_VOLUME_ATTN,
                                                        (short)Solidus_Settings.Volume_Settings.Volume_ATTN_Index);
                    Message = " SPEAKER_ATTN: " + Convert.ToString(Solidus_Settings.Volume_Settings.Volume_ATTN_Index);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "DIGITAL_SPEAKER_ATTN=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Volume_Settings.Digital_Volume_ATTN_index = temp_int;
                    Volume_Attn_button8.Text = Convert.ToString(Solidus_Settings.Volume_Settings.Digital_Volume_ATTN_index);
                    //oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_VOLUME_ATTN,
                    //                                    (short)Solidus_Settings.Volume_Settings.Volume_ATTN_Index);
                    Message = " DIGITAL_SPEAKER_ATTN: " + Convert.ToString(Solidus_Settings.Volume_Settings.Digital_Volume_ATTN_index);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "MIC_DIGITAL_VOLUME=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Volume_Settings.Mic_Digital_Volume = temp_int;
                    Settings.Default.Digital_Volume = temp_int;
                    Message = " MIC_DIGITAL_VOLUME: " + Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Digital_Volume);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "MIC_VOICE_VOLUME=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Volume_Settings.Mic_Voice_Volume = temp_int;
                    Settings.Default.Voice_Volume = temp_int;
                    Message = " MIC_VOICE_VOLUME: " + Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Voice_Volume);
                    Write_Debug_Message(Message);
                }
                ...
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Volume_Settings.Mic_Mute = temp_int;
                    if (Solidus_Settings.Volume_Settings.Mic_Mute == 1)
                    {
                        TX_Mute_button2.ForeColor = Color.White;
                        TX_Mute_button2.BackColor = Color.Red;
                    ...
                    else
                    {
                        ...
                        TX_Mute_button2.BackColor = Color.Gainsboro;
                    ...
                    Message = " MIC_MUTE: " + Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Mute);
                    Write_Debug_Message(Message);
                }
                ...
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Volume_Settings.Mic_Pre_Gain = temp_int;
                    Mic_Pre_Gain_button8.Text = Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Pre_Gain);
                    oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_MIC_GAIN,
                                                                   (short)Solidus_Settings.Volume_Settings.Mic_Pre_Gain);
                    Message = " MIC_PRE_GAIN: " + Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Pre_Gain);
                    Write_Debug_Message(Message);
                }
                ...
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Volume_Settings.Speaker_Mute = temp_int;
                    if (temp_int == 1)
                    {
                        Settings.Default.Speaker_MutED = true;
                        Set_Button_Color(true, Volume_Mute_button2, "MUTED");
                    ...
                    Message = " SPEAKER_MUTE: " + Convert.ToString(Solidus_Settings.Volume_Settings.Speaker_Mute);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "BUTTON_BACKGROUND=", ";");
                if (temp_string != "")
                {
                    Int32.TryParse(temp_string, out temp_32);
                    Master_Controls.Display_Colors.Button_Active_Background = Color.FromArgb(temp_32);
                }

                temp_string = getBetween(line, "BUTTON_FOREGROUND=", ";");
                if (temp_string != "")
                {
                    Int32.TryParse(temp_string, out temp_32);
                    Master_Controls.Display_Colors.Button_Active_Foreground = Color.FromArgb(temp_32);
                }
                ...
                if (temp_string != "")
                {
                    ...
                    //Message = " BACKGROUND_COLOR: " + Solidus_Settings.Background_Color;
                    //Write_Debug_Message(Message);
                }
                ...
                if (temp_string != "")
                {
                    ...
                    //Message = " TEXT_COLOR: " + Solidus_Settings.Text_Color;
                    //Write_Debug_Message(Message);
                }
                ...
                if (temp_string != "")
                {
                    ...
                    //Message = " BOARDER_COLOR: " + Solidus_Settings.Boarder_Color;
                    //Write_Debug_Message(Message);
                ...
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Peak_Needle = temp_int;
                    if (Solidus_Settings.Peak_Needle == 1)
                    {
                    ...
                    Message = " PEAK_NEEDLE: " + Convert.ToString(Solidus_Settings.Peak_Needle);
                    Write_Debug_Message(Message);
                }
                ...
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Peak_Needle_Delay_Index = temp_int;
                    Peak_Needle_Delay_listBox1.SelectedIndex = Solidus_Settings.Peak_Needle_Delay_Index;
                    Settings.Default.Meter_Peak_Hold = (byte)Solidus_Settings.Peak_Needle_Delay_Index;
                    Message = " PEAK_NEEDLE_DELAY_INDEX: " + Convert.ToString(Solidus_Settings.Peak_Needle_Delay_Index);
                    Write_Debug_Message(Message);
                }
                ...
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Peak_Needle_Color_Index = temp_int;
                    Meter_Peak_Needle_Color.SelectedIndex = Solidus_Settings.Peak_Needle_Color_Index;
                    Settings.Default.Meter_Peak_Needle_Color = (byte)Solidus_Settings.Peak_Needle_Color_Index;
                    Message = " PEAK_NEEDLE_COLOR_INDEX: " + Convert.ToString(Solidus_Settings.Peak_Needle_Color_Index);
                    Write_Debug_Message(Message);
                }
                ...
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Time_Display = temp_int;
                    if (Solidus_Settings.Time_Display == 1)
                    {
                    ...
                    Message = " TIME_DISPLAY: " + Convert.ToString(Solidus_Settings.Time_Display);
                    Write_Debug_Message(Message);
                }
                ...
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Meter_Mode = temp_int;
                    Smeter_controls.mode = (byte)Solidus_Settings.Meter_Mode;
                    Reset_Meter_Buttons();
                    Set_Meter_Indicator(Smeter_controls.mode);
                    Message = " METER_MODE: " + Convert.ToString(Solidus_Settings.Meter_Mode);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "SHUTDOWN=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Shutdown = (byte)temp_int;
                    if (Solidus_Settings.Shutdown == 1)
                    {
                        Shutdown_checkBox2.Checked = true;
                    }
                    else
                    {
                        Shutdown_checkBox2.Checked = false;
                    }
                    Message = " SHUTDOWN: " + Convert.ToString(Solidus_Settings.Shutdown);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "FAN_CONTROL=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Master_Controls.Solidus_Fan_Control = temp_int;
                    if (Master_Controls.Solidus_Fan_Control == 0)
                    {
                        Fan_Control_button8.Text = "PWM ON";
                    }
                    else
                    {
                    ...
                    Message = " FAN_CONTROL: " + Convert.ToString(Master_Controls.Solidus_Fan_Control);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "FAN_TEMPERATURE=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Master_Controls.Solidus_Fan_On_Temperature = temp_int;
                    ...
                    Message = " FAN_CONTROL: " + Convert.ToString(Master_Controls.Solidus_Fan_On_Temperature);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "METER_HOLD=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Meter_Hold = temp_int;
                    Power_Meter_Hold.Value = Solidus_Settings.Meter_Hold;
                    Message = " METER_HOLD: " + Convert.ToString(Solidus_Settings.Meter_Hold);
                    Write_Debug_Message(Message);
                    buf[0] = Master_Controls.Extended_Commands.CMD_SET_METER_HOLD;
                    buf[1] = (byte)Solidus_Settings.Meter_Hold;
                    oCode.SendCommand_MultiByte(txsocket, txtarget, Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND,
                        buf, buf.Length);
                }

                temp_string = getBetween(line, "QRP_TUNE_POWER=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.QRP_Tune_Power = temp_int;
                    Message = " QRP_TUNE_POWER: " + Convert.ToString(Solidus_Settings.QRP_Tune_Power);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "SMETER_COLOR=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Meter_Background_Color_Index = temp_int;
                    Meter_Background_listBox1.SelectedIndex = Solidus_Settings.Meter_Background_Color_Index;
                    Message = " SMETER_COLOR: " + Convert.ToString(Solidus_Settings.Meter_Background_Color_Index);
                    Write_Debug_Message(Message);
                }

                temp_string = getBetween(line, "BAND_CHANGE_TUNE=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    switch (temp_int)
                    ...
                    Message = " BAND_CHANGE_TUNE: " + Convert.ToString(Solidus_Settings.QRP_Tune_Power);
                    Write_Debug_Message(Message);
                }
                ...
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Solidus_Settings.Volume_Settings.Mic_Mode = temp_int;
                    switch (Solidus_Settings.Volume_Settings.Mic_Mode)
                    {
                        case 1:
                            Audio_Digital_button3.Text = "D";
                            Solidus_Settings.Volume_Settings.Mic_Is_Digital = true;
                            Compression_button4.Enabled = false;
                            Compression_button2.Enabled = false;
                            MicVolume_hScrollBar1.Value = Solidus_Settings.Volume_Settings.Mic_Digital_Volume;
                            Microphone_textBox2.Text = Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Digital_Volume);
                            oCode.SendCommand(txsocket, txtarget, Master_Controls.CMD_SET_CONFIGURATION_COMMAND,
                                                    Volume_Controls.SET_LINEIN_LINEOUT);
                            oCode.SendCommand(txsocket, txtarget,
                                Volume_Controls.CMD_SET_MIC_VOLUME, (short)Solidus_Settings.Volume_Settings.Mic_Digital_Volume);
                            oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_COMPRESSION_STATE, 0);

                            Solidus_Settings.Volume_Settings.Master_Speaker_Volume = Solidus_Settings.Volume_Settings.Speaker_Volume;
                            Volume_hScrollBar1.Value = Solidus_Settings.Volume_Settings.Master_Speaker_Volume;
                            Volume_textBox2.Text = Convert.ToString(Solidus_Settings.Volume_Settings.Master_Speaker_Volume);
                            oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_SPEAKER_VOLUME,
                                                                (short)Solidus_Settings.Volume_Settings.Master_Speaker_Volume);
                            oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_VOLUME_ATTN,
                                                            (short)Solidus_Settings.Volume_Settings.Digital_Volume_ATTN_index);
                            break;
                        default:
                            Audio_Digital_button3.Text = "P";
                            Compression_button4.Enabled = true;
                            Compression_button2.Enabled = true;
                            Solidus_Settings.Volume_Settings.Mic_Is_Digital = false;
                            MicVolume_hScrollBar1.Value = Solidus_Settings.Volume_Settings.Mic_Voice_Volume;
                            Microphone_textBox2.Text = Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Voice_Volume);
                            oCode.SendCommand(txsocket, txtarget, Master_Controls.CMD_SET_CONFIGURATION_COMMAND,
                                                    Volume_Controls.SET_SPEAKER_MICROPHONE);
                            oCode.SendCommand(txsocket, txtarget,
                                Volume_Controls.CMD_SET_MIC_VOLUME, (short)Solidus_Settings.Volume_Settings.Mic_Voice_Volume);

                            Solidus_Settings.Volume_Settings.Master_Speaker_Volume =
                                                                Solidus_Settings.Volume_Settings.Speaker_Voice_Volume;
                            Volume_hScrollBar1.Value = Solidus_Settings.Volume_Settings.Master_Speaker_Volume;
                            Volume_textBox2.Text = Convert.ToString(Solidus_Settings.Volume_Settings.Master_Speaker_Volume);
                            oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_SPEAKER_VOLUME,
                                                                (short)Solidus_Settings.Volume_Settings.Master_Speaker_Volume);
                    ...
                    Message = " MIC_MODE: " + Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Pre_Gain);
                    Write_Debug_Message(Message);
                }
            }
            file.Close();
            Init_CW_Settings();
            Manage_Colors();
            //Solidus_Settings.RPi_Configured = true;
        ...
        public void Finish_Initialization()
        {
...
#if RPI
            Solidus_Settings.RPi_Configured = Init_RPi_Settings();
#endif
            ...
            MSCC_Core_Version_label45.Text = Master_Controls.productVersion.ToString("1yy.MM.dd");
            //Set up the start up defaults for the filters
            Filter_control.Filter_High_Index = 4;
            Filter_control.Previous_Filter_High_Index = 10;
            ...
            buf[0] = Master_Controls.Extended_Commands.CMD_SET_METER_HOLD;
            buf[1] = Smeter_controls.SWR_Meter_Hold;
            oCode.SendCommand_MultiByte(txsocket, txtarget,
                                         Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND, buf, buf.Length);
            try
            {
                BackgroundWorker manage_background = new BackgroundWorker();
                manage_background.DoWork += Manage_Background;
                manage_background.RunWorkerAsync();
            }
            catch
            {
                Write_Debug_Message(" Background Start: keep_alive FAILED");
            }
        ...
        public void Post_Initialization()
        {
            byte[] buf = new byte[2];
            String Message;
            bool Proficio_Calibrated_band = true;
            ...
            buf[0] = Master_Controls.Extended_Commands.CMD_SET_ANTENNA_SWITCH;
            buf[1] = Set_Antenna_Switch_Value(Settings.Default.Antenna_Switch);
            oCode.SendCommand_MultiByte(txsocket, txtarget,
                  Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND, buf, buf.Length);
            Message = " Post_Initialization -> ANTENNA_SWITCH: " + Convert.ToString(buf[1]);
            Write_Debug_Message(Message);
#if RPI
            ...
            {
                MessageBox.Show("PROFICIO HAS NOT BEEN FREQUENCY CALIBRATED.\r\nCLICK ON THE Proficio Cal TAB TO PERFORM CALIBRATION ",
                         "MSCC", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
            }
            Proficio_Calibrated_band = Proficio_Check_Calibrated_Bands();
            if (!Proficio_Calibrated_band)
            {
                MessageBox.Show("ONE OR MORE PROFICIO BANDS HAVE NOT BEEN POWER CALIBRATED.\r\nCLICK ON THE Proficio Pwr TAB TO CHECK ",
                         "MSCC", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
            }
            if (Master_Controls.QRP_Mode)
            {
                Tune_Power_hScrollBar1.Value = Solidus_Settings.QRP_Tune_Power;
                Tune_Power_label37.Text = Convert.ToString(Solidus_Settings.QRP_Tune_Power);
            }
            else
            {
            ...
            //The following routes are work arounds for the Bogus implementation of Mono
            AM_Carrier_hScrollBar1.Value = Power_Controls.AM_Power;
            CW_Power_hScrollBar1.Value = Power_Controls.CW_Power;
            Power_hScrollBar1.Value = Power_Controls.Main_Power;
            ...
            MonitorTextBoxText(" Post_Initialization Finished");
#endif
            oCode.SendCommand(txsocket, txtarget, AGC_ALC_Notch_Controls.CMD_SET_ALC_MULTIPLIER,
                                                                    (short)AGC_ALC_Notch_Controls.ALC_Value);
        }
        /*public void Show_Message(string message,bool highlight)
        {
            StartUP_label44.Enabled = true;
            StartUP_label44.Visible = true;
            if (highlight)
            {
                StartUP_label44.BackColor = Color.Red;
                StartUP_label44.ForeColor = Color.White;
            }
            else
            {
                StartUP_label44.BackColor = Color.Gainsboro;
                StartUP_label44.ForeColor = Color.White;
            }
            StartUP_label44.Text = message;
        }*/
        //The following routes are work arounds for the Bogus implementation of Mono
        private void Volume_hScroolBar1_mouseenter(object sender, EventArgs e)
        {
            MonitorTextBoxText(" Volume Enter");
            Manage_Mouse(false);
        }
        private void Volume_hScroolBar1_mouseleave(object sender, EventArgs e)
        {
            MonitorTextBoxText(" Volume Leave");
            Manage_Mouse(true);
        }
        public void Manage_Mouse(bool on_off)
        {
            MonitorTextBoxText(" Manage_Mouse: " + Convert.ToString(on_off));
            switch (on_off)
            {
                case true:
                    this.MouseWheel += this.Main_MouseWheel;
                    this.mainPage.Enter += this.Main_Tab_Enter;
                    break;
                case false:
                    this.MouseWheel -= this.Main_MouseWheel;
                    this.mainPage.Enter -= this.Main_Tab_Enter;
        ...
        /*private void ritonofflabel11_Click(object sender, EventArgs e)
{
        ...
        /*public void Do_Fine_Calibration()
        {
            MonitorTextBoxText(" Do_Fine_Calibration Called");
            //oCode.SendCommand32(txsocket, txtarget, Frequency_Calibration_controls.CMD_SET_CAL_RESET, 0);
            ...
            calibratebutton1.Text = "RUNNING FINE\r\nCALIBRATION";
        }*/
        private void calibratebutton1_Click_1(object sender, EventArgs e)
        {
            if (oCode.isLoading) return;
            if (Frequency_Calibration_controls.Frequency_Calibrated == 0 &&
                                                Frequency_Calibration_controls.Reset_pressed == false)
            {
                MessageBox.Show("PROFICIO CALIBRATION HAS NOT BEEN INITIALIZED.\n\rPRESS THE RESET BUTTON\r\nAND THEN CLICK THE CALIBRATE BUTTON",
                    "MSCC-Core", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                return;
            }
            ...
            DialogResult ret = MessageBox.Show("THE TRANSCEIVER OSCILATOR WILL BE CALIBRATED.\r\n" +
            ...
            if (ret == DialogResult.Yes)
            {
                ...
                if (Frequency_Calibration_controls.Reset)
                {
                    calibratebutton1.Text = "RUNNING\r\nCOARSE CALIBRATION\r\nPLEASE WAIT";
        ...
        */
        ...
        private void Manage_Rit(int step, int limit_index)
        {
            switch (step)
            {
                ...
                case 50:
                    ...
                    break;
                case 100:
                    ritScroll.Minimum = -3000;
                    ritScroll.Maximum = 3099;
                    break;
            }
        }
        private void ritlistBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Rit_Controls.RIT_Step_Index = index;
            switch (index)
            {
                case 0:
                    ritScroll.LargeChange = 1;
            ...
            oCode.SendCommand32(txsocket, txtarget, Rit_Controls.CMD_SET_RIT_FREQ, 0);
            buf[0] = Master_Controls.Extended_Commands.CMD_SET_RIT_STEP;
            buf[1] = (byte)ritScroll.LargeChange;
            oCode.SendCommand_MultiByte(txsocket, txtarget,
                                                Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND, buf, buf.Length);
        ...
        {
            MonitorTextBoxText(" powertunebutton1_Click Entered ");
                ...
                if (Power_Calibration_Controls.Band_Is_Selected)
                {
                    if (Power_Calibration_Controls.Warning_Accepted)
                    {
                        if (!Power_Calibration_Controls.Tuning_Mode)
                        {
                            ...
                            Power_Calibration_Controls.TX_button = true;
                            ...
                            Set_Button_Color(true, powertunebutton1);
                            Master_Controls.Transmit_Mode = true;
                            Proficio_Pwr_groupBox6.Enabled = false;
                            Proficio_Calibrate_button8.Enabled = false;
                        }
                        else
                        {
                            Power_Calibration_Controls.Tuning_Mode = false;
                            Power_Calibration_Controls.TX_button = false;
                            oCode.SendCommand(txsocket, txtarget, Power_Calibration_Controls.CMD_CALIBRATION_TUNE, 0);
                            Set_Button_Color(false, powertunebutton1);
                            Master_Controls.Transmit_Mode = false;
                            Proficio_Pwr_groupBox6.Enabled = true;
                            Proficio_Calibrate_button8.Enabled = true;
                        }
                    }
                    else
                    {
                        DialogResult ret = MessageBox.Show("IS A WELL MATCHED ANTENNA OR DUMMY LOAD ATTACHED TO THE SOLIDUS?\n\r" +
                             "A 50Ω 5W OR BETTER DUMMY LOAD IS PREFERRED", "MSCC", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk);
                        if (ret == DialogResult.Yes)
                        {
                            Power_Calibration_Controls.Warning_Accepted = true;
                        }
            ...
            MonitorTextBoxText(" powertunebutton1_Click finished ");
        }
        ...
        /*private void label32_Click(object sender, EventArgs e)
{
        ...
        private void Manage_Rit_From_Server()
        {
            int MHz;
            int KHz;
            int Hz;
            ...
            Rit_Controls.Offset = Rit_Controls.RIT_Offset_From_Server;
            ...
            ritfreqtextBox1.Text = Convert.ToString(MHz) + "." + string.Format("{0:000}", KHz) + "." +
        ...
        private void buttTune_Click(object sender, EventArgs e)
        {
            ...
            if (!Master_Controls.TX_Inhibited)
            {
                if (!Power_Controls.Full_power)
                {
                    if (Master_Controls.QRP_Mode)
                    {
                        tx_power = (short)Solidus_Settings.QRP_Tune_Power;
                    }
                    else
                    {
                ...
                if (Master_Controls.Tuning_Mode == false)
                {
                    ...
                    Band_groupBox6.Enabled = false;
                    Main_QRP_button8.Enabled = false;
                }
                else
                {
                    if (!Settings.Default.Speaker_MutED)
                    ...
                    Band_groupBox6.Enabled = true;
                    Main_QRP_button8.Enabled = true;
                }
            }
...
*/
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            if (!Master_Controls.TX_Inhibited)
            {
                ...
                {
                    //oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_SPEAKER_MUTE, 1);
                    if (Last_used.Current_mode == 'C' && CW_Parameters.CW_Semi_Break_In == 1)
                    {
                        CW_Parameters.CW_Semi_Break_In = 0;
                        oCode.SendCommand(txsocket, txtarget, oCode.SET_SEMI_BREAKIN, CW_Parameters.CW_Semi_Break_In);
                        semicheckBox2.CheckedChanged -= semicheckBox2_CheckedChanged;
                        semicheckBox2.Checked = false;
                        semicheckBox2.CheckedChanged += semicheckBox2_CheckedChanged;
                        MessageBox.Show("SETTING CW SEMI BREAKIN OFF", "MSCC", MessageBoxButtons.OK,
...
*/
        ...
        */
        ...
        private void B160radioButton_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                Proficio_Calibrate_button8.Text = "CALIBRATE";
        ...
        private void B17radioButton_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                Proficio_Calibrate_button8.Text = "CALIBRATE"; 
                MonitorTextBoxText(" 17m Power Button Clicked");
                Power_Calibration_Controls.Band_Is_Selected = true;
        ...
        private void MFC_Enter(object sender, EventArgs e)
        {
            ...
            MonitorTextBoxText(" MFC_Enter -> Master_Controls.QRP_Mode: " + Convert.ToString(Master_Controls.QRP_Mode));
            if (Solidus_Settings.Mia_Status)
            {
                ...
                Amplifier_Power_Controls.Previous_Tune_power = Power_Controls.TUNE_Power;
                TabPage CurrrentTabProperty = powertabControl1.SelectedTab;
            }
#if RPI
            MonitorTextBoxText(" MFC_Enter -> Antenna_Switch: " +
                    Convert.ToString(Solidus_Settings.Antenna_Switch));
            switch (Solidus_Settings.Antenna_Switch)
            {
                case 0:
                    Antenna_Switch_button8.Text = "160M";
...
#endif
            MonitorTextBoxText(" MFC_Enter -> Finished");
        }
        private void MFC_Leave(object sender, EventArgs e)
        {
            byte[] buf = new byte[2];

            MonitorTextBoxText(" MFC_Leave -> Master_Controls.QRP_Mode: " + Convert.ToString(Master_Controls.QRP_Mode));
            PA_Display_Power_Timer.Enabled = false;
            PA_Display_Power_Timer.Stop();
            IQ_Controls.Calibration_Band_Count = -1;
            Calibration_Band_button8.Text = "SEL";
            oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_RIG_TUNE, 0);
            oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_TX_ON, 0);
            //AMP_Tune_button4.ForeColor = Color.Black;
            //AMP_Tune_button4.BackColor = Color.Gainsboro;
            PA_Auto_Calibrate_button8.Text = "CALIBRATE";
            Set_Button_Color(false, PA_Auto_Calibrate_button8);
            Solidus_Tab_Power_Display_label33.Text = "PA Power: ";
            Amplifier_Power_Controls.Tuning_Mode = false;
            Amplifier_Power_Controls.Bias_On = false;
            Antenna_Switch_button8.Enabled = true;
            Set_Button_Color(false, PA_TX_button8);
            button1.Enabled = true;
            Set_Button_Color(false, buttTune);
            Set_Button_Color(false, button1);
            Set_Button_Color(false, Solidus_Bias_button8);
            ...
            oCode.SendCommand(txsocket, txtarget, Amplifier_Power_Controls.CMD_SET_BIAS, 0);
            ...
            if (IQ_Controls.Calibrating == true)
            {
                IQBD_Cancel_button8_Click(null, null);
            }
            ...
            Set_Button_Color(false, IQBD_Auto_button8);
            IQBD_Auto_button8.Text = "I/Q CALIBRATION";
            ...
            Band_groupBox6.Enabled = true;
            Main_QRP_button8.Enabled = true;
            Amplifier_Power_Controls.PA_Calibrating = false;
            ...
            TabPage CurrrentTabProperty = powertabControl1.SelectedTab;
            MonitorTextBoxText(" MFC_Leave -> Finished");
        }
        private void Main_Tab_Enter(object sender, EventArgs e)
        {
            MonitorTextBoxText(" Main_Tab_Enter -> Entered");
#if RPI
            ...
            Set_Textbox_Color(false, band_stack_textBox1);
            if (Solidus_Settings.Volume_Settings.Mic_Is_Digital)
            {
                oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_MIC_GAIN, 0);
                oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_MIC_VOLUME, 
                                                            (short)Solidus_Settings.Volume_Settings.Mic_Digital_Volume);
            }
            else
            {
                oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_MIC_GAIN, 
                                                                (short)Solidus_Settings.Volume_Settings.Mic_Pre_Gain);
                oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_MIC_VOLUME,
                                                            (short)Solidus_Settings.Volume_Settings.Mic_Voice_Volume);
            }
            MonitorTextBoxText(" Main_Tab_Enter -> Finished");
        }
        private void Main_Tab_Leave(object sender, EventArgs e)
        {
            MonitorTextBoxText(" Main_Tab_Leave -> Entered");
#if RPI
            this.Size = Full_size;
            //UTC_Date_label46.Visible = false;
            //Time_display_UTC_label34.Visible = false;
            ...
            MonitorTextBoxText(" Main_Tab_Leave -> Finished");
        ...
        private void powertabPage1_Enter(object sender, EventArgs e)
        {
            ...
            Proficio_Check_Band_Calibration();
        }
        ...
        private void freqcaltab_Leave(object sender, EventArgs e)
        {
            ...
            if (IQ_Controls.IQ_Server_Calibrating || Frequency_Calibration_controls.Calibration_In_Progress)
            {
            ...
            oCode.SendCommand_MultiByte(txsocket, txtarget,
                                                Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND, buf, buf.Length);
            Frequency_Calibration_controls.Calibration_Checked = false;
            switch (oCode.current_band)
            {
                case 160:
                    main160radioButton10_CheckedChanged(null, null);
        ...
        */
        ...
        private void Volume_hScrollBar1_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            if (Solidus_Settings.Volume_Settings.Master_Speaker_Volume == value) return;
            ...
            if (!Solidus_Settings.Volume_Settings.Mic_Is_Digital)
            {
                Solidus_Settings.Volume_Settings.Speaker_Voice_Volume = value;
            }
            else
            {
                Solidus_Settings.Volume_Settings.Speaker_Volume = value;
            }
            Solidus_Settings.Volume_Settings.Master_Speaker_Volume = value;
            //Solidus_Settings.RPi_Needs_Updated = true;

#if FTDI
            Tuning_Knob_Controls.Volume_Function.Volume = Volume_Controls.Speaker_Volume;
#endif
            Volume_textBox2.Text = Convert.ToString(value);
        ...
        */
...
#if RPI
                    if (Master_Controls.RPi_Update_Counter++ >= 60)
                    {
                        if (Solidus_Settings.RPi_Configured)
                        {
                           // Update_RPi_Settings();
                        }
                        Master_Controls.RPi_Update_Counter = 0;
                    }
#endif
                }
#if FTDI
        ...
        private void Tune_Power_hScrollBar1_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            //if (Power_Controls.TUNE_Power == (short)value)
            //{
            //    return;
            //}
            if (Master_Controls.QRP_Mode)
            {
                Solidus_Settings.QRP_Tune_Power = value;
            }
            else
            {
        ...
        private void Volume_Mute_button2_Click(object sender, EventArgs e)
        {
            ...
            if (!Settings.Default.Speaker_MutED)
            {
                ...
                oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_SPEAKER_MUTE, 1);
                Solidus_Settings.Volume_Settings.Speaker_Mute = 1;
                Settings.Default.Speaker_MutED = true;
                //Solidus_Settings.RPi_Needs_Updated = true;
            }
            else
        ...
        public bool Init_Power_values()
        {
            ...
            MonitorTextBoxText(" Init_Power_values -> Entered");
            List<string> MyList = new List<string>();
            ...
            while ((line = file.ReadLine()) != null)
            {
                ...
                MonitorTextBoxText(" AM Power: " + Convert.ToString(temp_int));
                ...
                MonitorTextBoxText(" LSB Power: " + Convert.ToString(temp_int));
                ...
                Power_Controls.Main_Power = temp_int;
                SSB_Power_label36.Text = Convert.ToString(temp_int) + " %";
                MonitorTextBoxText(" USB Power: " + Convert.ToString(temp_int));
                ...
                MonitorTextBoxText(" CW Power: " + Convert.ToString(temp_int));
                ...
                MonitorTextBoxText(" TUNE Power: " + Convert.ToString(temp_int));
            }
            file.Close();
            MonitorTextBoxText(" Init_Power_values -> finished");
            return true;
        }
    ...
    return true;
        ...
        private void MicVolume_hScrollBar1_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            if (Solidus_Settings.Volume_Settings.Mic_Is_Digital)
            {
                ...
                Solidus_Settings.Volume_Settings.Mic_Digital_Volume = Settings.Default.Digital_Volume;
            ...
            else
            {
                ...
                Solidus_Settings.Volume_Settings.Mic_Voice_Volume = Settings.Default.Voice_Volume;
            ...
            if (Volume_Controls.Mic_MutED)
            {
                ...
                TX_Mute_button2.Text = "Mic Gain";
                Volume_Controls.Mic_MutED = false;
                Solidus_Settings.Volume_Settings.Mic_Mute = 0;
                oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_MIC_MUTE, 0);
            }
        ...
        */
        private void TX_Mute_button2_Click(object sender, EventArgs e)
        {
            ...
            if (!Volume_Controls.Mic_MutED)
            {
                ...
                Set_Button_Color(true, TX_Mute_button2, "MUTED");
                Volume_Controls.Mic_MutED = true;
                oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_MIC_MUTE, 1);
                Solidus_Settings.Volume_Settings.Mic_Mute = 1;
                //Solidus_Settings.RPi_Needs_Updated = true;
            }
            else
            {
                MonitorTextBoxText(" TX_Mute_Button2 -> Called -> Set Mute OFF");
                Set_Button_Color(false, TX_Mute_button2, "Mic Gain");
                oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_MIC_MUTE, 0);
                Volume_Controls.Mic_MutED = false;
                Solidus_Settings.Volume_Settings.Mic_Mute = 0;
                //Solidus_Settings.RPi_Needs_Updated = true;
        ...
        /*private void Standard_Carrier_listBox1_SelectedIndexChanged(object sender, EventArgs e)
{
    ...
    if (!Master_Controls.Transceiver_Warming)
    {
        ...
        Calibration_progressBar1.Value = 0;
        Freq_CAl_Progress_Lable.Text = "0";
        label57.Visible = true;
        calibratebutton1.Visible = true;
        Calibration_progressBar1.Visible = true;
        //Progress_label58.Visible = true;
        ...
        Frequency_Calibration_controls.Standard_carrier_selected_index++;
        if(Frequency_Calibration_controls.Standard_carrier_selected_index > 9)
        {
            Frequency_Calibration_controls.Standard_carrier_selected_index = 0;
        }
        Frequency_Calibration_controls.standard_carrier_selected = true;
        switch (value)
        {
...
*/
        ...
        {
            MonitorTextBoxText(" Setting Start UP Band: " + Convert.ToString(Master_Controls.Startup_Band));
        ...
        private void PA_vButton1_Click_1(object sender, EventArgs e)
        {
            ...
            if (Solidus_Settings.Mia_Status)
            {
                if (!Master_Controls.Transmit_Mode)
                {
                    if (Master_Controls.QRP_Mode)
                    {
                        Set_Button_Color(true, PA_vButton1, "QRO");
                        Set_Button_Color(true, Main_QRP_button8, "QRO");
                        Master_Controls.QRP_Mode = false;
                        oCode.SendCommand(txsocket, txtarget, Master_Controls.CMD_SET_PA_BYPASS, 1);
                        Tune_Power_label37.Text = Convert.ToString(Power_Controls.TUNE_Power);
                        Tune_Power_hScrollBar1.Value = Power_Controls.TUNE_Power;
                        MonitorTextBoxText(" PA_vButton1_Click -> Set QRO Mode " + "Power_Controls.TUNE_Power: " +
                            Convert.ToString(Power_Controls.TUNE_Power));
                    }
                    else
                    {
                        Set_Button_Color(false, PA_vButton1, "QRP");
                        Set_Button_Color(false, Main_QRP_button8, "QRP");
...
*/
        ...
        public bool Initialize_MFC()
        {
            ...
            knob_switch = Check_MFC_Value(knob_switch);
            left_switch = Convert.ToInt16(MFC_arr[2]);
            left_switch = Check_MFC_Value(left_switch);
            middle_switch = Convert.ToInt16(MFC_arr[3]);
            middle_switch = Check_MFC_Value(middle_switch);
            right_switch = Convert.ToInt16(MFC_arr[4]);
            right_switch = Check_MFC_Value(right_switch);
            state = Convert.ToInt16(MFC_arr[5]);
            ptt_switch = Convert.ToInt16(MFC_arr[6]);
            ptt_switch = Check_MFC_Value(ptt_switch);
            ...
            MonitorTextBoxText(" Initialize_MFC -> middle_switch: " + Convert.ToString(middle_switch));
...
*/
        ...
        private void Auto_Zero_checkBox2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                Settings.Default.Auto_Zero = false;
                Solidus_Settings.Auto_Zero = 0;
                buf[1] = 0;
            }
            else
            {
                Settings.Default.Auto_Zero = true;
                Solidus_Settings.Auto_Zero = 1;
                buf[1] = 1;
            }
            oCode.SendCommand_MultiByte(txsocket, txtarget, Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND,
                                                                buf, buf.Length);
        ...
        */
        ...
        private void Band_Change_Auto_Tune_checkBox2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                Settings.Default.Band_Change_Tune = true;
                Solidus_Settings.Band_Change_Tune = 1;
            }
            else
            {
                Settings.Default.Band_Change_Tune = false;
                Solidus_Settings.Band_Change_Tune = 0;
            }
        }
        ...
        {
            if (Amplifier_Power_Controls.PA_Band_Selected)
            {
                if (Amplifier_Power_Controls.Bias_On == false)
                {
                    ...
                    oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, Mode.TUNE_MODE);
                    oCode.SendCommand(txsocket, txtarget, Amplifier_Power_Controls.CMD_SET_BIAS, 1);
                    Set_Button_Color(true, Solidus_Bias_button8);
                    Master_Controls.Tuning_Mode = false;
                    Master_Controls.Transmit_Mode = false;
                    IQBD_groupBox4.Enabled = false;
                    Calibration_Band_button8.Enabled = false;
                }
                else
                {
                    Amplifier_Power_Controls.Bias_On = false;
                    ...
                    oCode.SendCommand(txsocket, txtarget, Power_Controls.CMD_SET_TUNE_POWER,
                                            Power_Controls.TUNE_Power);
                    oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, Mode.TUNE_MODE);
                    Set_Button_Color(false, Solidus_Bias_button8);
                    IQBD_groupBox4.Enabled = true;
                    Calibration_Band_button8.Enabled = true;
                }
            }
            else
            {
                _ = MessageBox.Show("Select Any Band", "MSCC", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
            }
        }
        ...
        /*private void ALC_label5_Click(object sender, EventArgs e)
{
        ...
        private void Audio_Digital_button3_Click(object sender, EventArgs e)
        {
            ...
            if (!Solidus_Settings.Volume_Settings.Mic_Is_Digital)
            {
                Audio_Digital_button3.Text = "D";
                Solidus_Settings.Volume_Settings.Mic_Is_Digital = true;
                Solidus_Settings.Volume_Settings.Mic_Mode = 1;
                ...
                Volume_textBox2.Text = Convert.ToString(Solidus_Settings.Volume_Settings.Speaker_Volume);
                oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_SPEAKER_VOLUME,
                                                    (short)Solidus_Settings.Volume_Settings.Speaker_Volume);
                oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_VOLUME_ATTN,
                                                            (short)Solidus_Settings.Volume_Settings.Digital_Volume_ATTN_index);
            ...
            else
            {
                ...
                Compression_button2.Enabled = true;
                Solidus_Settings.Volume_Settings.Mic_Is_Digital = false;
                Solidus_Settings.Volume_Settings.Mic_Mode = 0;
                if (Volume_Controls.Compression_State == 1)
                {
                    Set_Button_Color(true, Compression_button2);
                    Set_Button_Color(true, Compression_button4);
                    oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_COMPRESSION_STATE, 1);
                }
                ...
                Volume_textBox2.Text = Convert.ToString(Solidus_Settings.Volume_Settings.Speaker_Voice_Volume);
                oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_SPEAKER_VOLUME,
                                                    (short)Solidus_Settings.Volume_Settings.Speaker_Voice_Volume);
                oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_VOLUME_ATTN,
                                                        (short)(short)Solidus_Settings.Volume_Settings.Volume_ATTN_Index);
#else
                MonitorTextBoxText(" Audio_Digital_button3: " + Convert.ToString(Settings.Default.Mic_Is_Digital));
            ...
            MonitorTextBoxText(" Audio_Digital_button3: " + Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Mode));
        }
...
private void checkBox2_CheckedChanged(object sender, EventArgs e)
{
    ...
    else
    {
        ...
        private void Manage_Colors()
        {
            ...
            //Band_groupBox6.BackColor = Settings.Default.Boarder_Color;
        }
    ...
    switch (Window_controls.Docking_Controls.Last_Sized.Order)
    {
        ...
        private void B160_Favs_listView1_SelectedIndexChanged_2(object sender, EventArgs e)
        {
            ...
            if (B160_Favs_listView1.SelectedItems.Count != 0)
            {
                ...
                Set_Textbox_Color(true, band_stack_textBox1);
        ...
        private void main160radioButton10_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (oCode.previous_main_band != 160)
            {
                ...
                if (!Power_Calibration_Controls.Power_Tab_Active && !Amplifier_Power_Controls.Tab_Active)
                {
                    ...
                    Filter_control.Filter_High_Index = Last_used.B160.Filter_High_Index;
                    Filter_control.CW_Filter_Index = Last_used.B160.Filter_CW_index;
                    Filter_control.Filter_Low_Index = Last_used.B160.Filter_Low_Index;
                }
        ...
        private void main80radioButton9_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (oCode.previous_main_band != 80)
            {
                ...
                if (!Power_Calibration_Controls.Power_Tab_Active && !Amplifier_Power_Controls.Tab_Active)
                {
                    ...
                    oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, mode_number);
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B80.Freq);
                    Filter_control.Filter_High_Index = Last_used.B80.Filter_High_Index;
                    Filter_control.CW_Filter_Index = Last_used.B80.Filter_CW_index;
                    Filter_control.Filter_Low_Index = Last_used.B80.Filter_Low_Index;
                    oCode.modeswitch = mode_number;
        ...
        private void main60radioButton8_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (oCode.previous_main_band != 60)
            {
                ...
                if (!Power_Calibration_Controls.Power_Tab_Active && !Amplifier_Power_Controls.Tab_Active)
                {
                    ...
                    oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, mode_number);
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B60.Freq);
                    Filter_control.Filter_High_Index = Last_used.B60.Filter_High_Index;
                    Filter_control.CW_Filter_Index = Last_used.B60.Filter_CW_index;
                    Filter_control.Filter_Low_Index = Last_used.B60.Filter_Low_Index;
                    oCode.modeswitch = mode_number;
                    //Band_button_clicked_get_freq_and_mode();
                }
        ...
        private void main40radioButton7_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (oCode.previous_main_band != 40)
            {
                ...
                if (!Power_Calibration_Controls.Power_Tab_Active && !Amplifier_Power_Controls.Tab_Active)
                {
                    ...
                    oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, mode_number);
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B40.Freq);
                    Filter_control.Filter_High_Index = Last_used.B40.Filter_High_Index;
                    Filter_control.CW_Filter_Index = Last_used.B40.Filter_CW_index;
                    Filter_control.Filter_Low_Index = Last_used.B40.Filter_Low_Index;
                    oCode.modeswitch = mode_number;
                }
            }
        }
        private void main30radioButton6_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (oCode.previous_main_band != 30)
            {
                ...
                if (!Power_Calibration_Controls.Power_Tab_Active && !Amplifier_Power_Controls.Tab_Active)
                {
                    ...
                    oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, mode_number);
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B30.Freq);
                    Filter_control.Filter_High_Index = Last_used.B30.Filter_High_Index;
                    Filter_control.CW_Filter_Index = Last_used.B30.Filter_CW_index;
                    Filter_control.Filter_Low_Index = Last_used.B30.Filter_Low_Index;
                    oCode.modeswitch = mode_number;
                    //Band_button_clicked_get_freq_and_mode();
                }
            }
        ...
        private void main20radioButton5_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (oCode.previous_main_band != 20)
            {
                ...
                if (!Power_Calibration_Controls.Power_Tab_Active && !Amplifier_Power_Controls.Tab_Active)
                {
                    ...
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B20.Freq);
                    oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, mode_number);
                    Filter_control.Filter_High_Index = Last_used.B20.Filter_High_Index;
                    Filter_control.CW_Filter_Index = Last_used.B20.Filter_CW_index;
                    Filter_control.Filter_Low_Index = Last_used.B20.Filter_Low_Index;
                    oCode.modeswitch = mode_number;
                }
            }
        }
        private void main17radioButton4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (oCode.previous_main_band != 17)
            {
                ...
                if (!Power_Calibration_Controls.Power_Tab_Active && !Amplifier_Power_Controls.Tab_Active)
                {
                    ...
                    oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, mode_number);
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B17.Freq);
                    Filter_control.Filter_High_Index = Last_used.B17.Filter_High_Index;
                    Filter_control.CW_Filter_Index = Last_used.B17.Filter_CW_index;
                    Filter_control.Filter_Low_Index = Last_used.B17.Filter_Low_Index;
                    oCode.modeswitch = mode_number;
                    //Band_button_clicked_get_freq_and_mode();
                }
            }
        ...
        private void main15radiobutton_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (oCode.previous_main_band != 15)
            {
                ...
                if (!Power_Calibration_Controls.Power_Tab_Active && !Amplifier_Power_Controls.Tab_Active)
                {
                    ...
                    oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, mode_number);
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B15.Freq);
                    Filter_control.Filter_High_Index = Last_used.B15.Filter_High_Index;
                    Filter_control.CW_Filter_Index = Last_used.B15.Filter_CW_index;
                    Filter_control.Filter_Low_Index = Last_used.B15.Filter_Low_Index;
                    oCode.modeswitch = mode_number;
                    //Band_button_clicked_get_freq_and_mode();
                }
            }
        ...
        private void main12radioButton2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (oCode.previous_main_band != 12)
            {
                ...
                if (!Power_Calibration_Controls.Power_Tab_Active && !Amplifier_Power_Controls.Tab_Active)
                {
                    ...
                    oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, mode_number);
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B12.Freq);
                    Filter_control.Filter_High_Index = Last_used.B12.Filter_High_Index;
                    Filter_control.CW_Filter_Index = Last_used.B12.Filter_CW_index;
                    Filter_control.Filter_Low_Index = Last_used.B12.Filter_Low_Index;
                    oCode.modeswitch = mode_number;
                    //Band_button_clicked_get_freq_and_mode();
                }
            }
        ...
        private void main10radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (oCode.previous_main_band != 10)
            {
                ...
                if (!Power_Calibration_Controls.Power_Tab_Active && !Amplifier_Power_Controls.Tab_Active)
                {
                    ...
                    oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, mode_number);
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B10.Freq);
                    Filter_control.Filter_High_Index = Last_used.B10.Filter_High_Index;
                    Filter_control.CW_Filter_Index = Last_used.B10.Filter_CW_index;
                    Filter_control.Filter_Low_Index = Last_used.B10.Filter_Low_Index;
                    oCode.modeswitch = mode_number;
                    //Band_button_clicked_get_freq_and_mode();
                }
            }
        ...
        private void genradioButton_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (oCode.previous_main_band != 200)
            {
                ...
                if (!Power_Calibration_Controls.Power_Tab_Active && !Amplifier_Power_Controls.Tab_Active)
                {
                    ...
                    oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, mode_number);
                    Filter_control.Filter_High_Index = Last_used.GEN.Filter_High_Index;
                    Filter_control.CW_Filter_Index = Last_used.GEN.Filter_CW_index;
                    Filter_control.Filter_Low_Index = Last_used.GEN.Filter_Low_Index;
                    oCode.modeswitch = mode_number;
                    //Band_button_clicked_get_freq_and_mode();
                }
            ...
            switch (op_code)
            {
                ...
                case Master_Controls.Extended_Commands.CMD_MFC_SET_RIT_MODE:
                    switch (operand)
                    {
                        case 0:
                            Rit_Controls.RIT_On = true;
                            Rit_Controls.RIT_Scroll_Bar_Status = true;
                            break;
                        case 1:
                            Rit_Controls.RIT_On = false;
                            Rit_Controls.RIT_Scroll_Bar_Status = false;
                            break;
                    }
                    ritbutton1_Click(null, null);
                ...
                case Master_Controls.Extended_Commands.CMD_SET_SOLIDUS_STATUS:
                    ...
                    {
                        case 0:
                            Solidus_Settings.Solidus_Status = false;
                            break;
                        default:
                            Solidus_Settings.Solidus_Status = true;
                            break;
                    }
                    Solidus_Settings.Solidus_Status_Set = true;
                ...
                case Master_Controls.Extended_Commands.CMD_SET_IQBD_DATA:
                    try
                    {
                        ...
                        //    Convert.ToString(value[0]));
                        IQBD_Monitor_label.Text = Convert.ToString(IQBD_Value);
                    }
                    catch (Exception e)
                    {
                ...
                case Master_Controls.Extended_Commands.CMD_SET_FORWARD_POWER:
                    try
                    {
                        ...
                        lower = (int)(meter_power & 0x00000FFF);
                        upper = (int)(meter_power >> 10);
                        //MonitorTextBoxText(" Process_extended_commands-> CMD_SET_FORWARD_POWER -> meter_power: " +
                        //    Convert.ToString(meter_power));
        ...
        /*public int adjust_bias(int bias)
{
    ...
    return scaled_bias;
        ...
        public void Apply_Band_Stack()
        {
            ...
            band_stack_textBox1.Text = Convert.ToString(MHz) + "." + string.Format("{0:000}", KHz) + 
                "." + (string.Format("{0:000}", Hz));
            Set_Textbox_Color(true, band_stack_textBox1);
            ...
            switch (oCode.current_band)
            {
                case 160:
                    ...
                    if (mode == 'C')
                    {
                        ...
                        Filter_control.Filter_High_Index = Last_used.B160.Filter_CW_index;
                    }
                    else
                    {
                        Filter_control.Filter_High_Index = Last_used.B160.Filter_High_Index;
                ...
                case 80:
                    ...
                    if (mode == 'C')
                    {
                        Filter_control.Filter_High_Index = Last_used.B80.Filter_CW_index;
                    }
                    else
                    {
                        Filter_control.Filter_High_Index = Last_used.B80.Filter_High_Index;
                ...
                case 60:
                    ...
                    if (mode == 'C')
                    {
                        Filter_control.Filter_High_Index = Last_used.B60.Filter_CW_index;
                    }
                    else
                    {
                        Filter_control.Filter_High_Index = Last_used.B60.Filter_High_Index;
                ...
                case 40:
                    ...
                    if (mode == 'C')
                    {
                        Filter_control.Filter_High_Index = Last_used.B40.Filter_CW_index;
                        MonitorTextBoxText(" set_main_mode_display -> Band 40 -> New Mode: " +
                            mode + ",CW Index: " + Last_used.B40.Filter_CW_index);
                    }
                    else
                    {
                        Filter_control.Filter_High_Index = Last_used.B40.Filter_High_Index;
                ...
                case 30:
                    ...
                    if (mode == 'C')
                    {
                        Filter_control.Filter_High_Index = Last_used.B30.Filter_CW_index;
                    }
                    else
                    {
                        Filter_control.Filter_High_Index = Last_used.B30.Filter_High_Index;
                ...
                case 20:
                    ...
                    if (mode == 'C')
                    {
                        Filter_control.Filter_High_Index = Last_used.B20.Filter_CW_index;
                    }
                    else
                    {
                        Filter_control.Filter_High_Index = Last_used.B20.Filter_High_Index;
                ...
                case 17:
                    ...
                    if (mode == 'C')
                    {
                        Filter_control.Filter_High_Index = Last_used.B17.Filter_CW_index;
                    }
                    else
                    {
                        Filter_control.Filter_High_Index = Last_used.B17.Filter_High_Index;
                ...
                case 15:
                    ...
                    if (mode == 'C')
                    {
                        Filter_control.Filter_High_Index = Last_used.B15.Filter_CW_index;
                    }
                    else
                    {
                        Filter_control.Filter_High_Index = Last_used.B15.Filter_High_Index;
                ...
                case 12:
                    ...
                    if (mode == 'C')
                    {
                        Filter_control.Filter_High_Index = Last_used.B12.Filter_CW_index;
                    }
                    else
                    {
                        Filter_control.Filter_High_Index = Last_used.B12.Filter_High_Index;
                ...
                case 10:
                    ...
                    if (mode == 'C')
                    {
                        Filter_control.Filter_High_Index = Last_used.B10.Filter_CW_index;
                    }
                    else
                    {
                        Filter_control.Filter_High_Index = Last_used.B10.Filter_High_Index;
        ...
        public byte Default_Filters_Count = 0;
        public bool Default_Filters_Configured = false;
        private void set_default_filter_configuration()
        {
            ...
            if (Default_Filters_Count == 3) Default_Filters_Configured = true;
        }
        private void Set_Rit(int freq)
        {
            int freq_plus_rit = freq + Rit_Controls.Offset;
            Rit_Controls.RIT_Freq = freq;
            int MHz = freq_plus_rit / 1000000;
            int KHz = (freq_plus_rit - (MHz * 1000000)) / 1000;
            int Hz = freq_plus_rit - (MHz * 1000000) - (KHz * 1000);
            ritfreqtextBox1.Text = Convert.ToString(MHz) + "." + string.Format("{0:000}", KHz) + "." + (string.Format("{0:000}", Hz));
        ...
        public void OnUdpData(IAsyncResult result)
        {
            ...
            switch (op_code)
            {
                case Master_Controls.CMD_SET_ANTENNA_SENSE:
                    ...
                    {
                        case 0:
                            //Antenna_Indicator_button8.BackColor = Color.Gainsboro;
                            Set_Button_Color(false, Antenna_Indicator_button8);
                            break;
                        case 1:
                            //Antenna_Indicator_button8.BackColor = Color.Red;
                            Set_Button_Color(true, Antenna_Indicator_button8);
                            break;
                    }
                    MonitorTextBoxText(" CMD_SET_ANTENNA_SENSE: " + Convert.ToString(operand));
                    break;

                case Volume_Controls.CMD_SET_VOLUME_BY_SERVER:
                    Solidus_Settings.Volume_Settings.Set_By_Server = true;
                    if (!Solidus_Settings.Volume_Settings.Mic_Is_Digital)
                    {
                        Solidus_Settings.Volume_Settings.Speaker_Voice_Volume = operand;
                    }
                    else
                    {
                        Solidus_Settings.Volume_Settings.Speaker_Volume = operand;
                    }
                    Solidus_Settings.Volume_Settings.Master_Speaker_Volume = operand;
                    break;

                case Rit_Controls.CMD_SET_RIT_FREQ:
                    Rit_Controls.RIT_Offset_From_Server = BitConverter.ToInt32(message, 1);
                    break;
...
#if RPI
                    Solidus_Settings.Freq_Step = operand;
#else
                ...
                case AGC_ALC_Notch_Controls.CMD_SET_ALC:
                    if (Master_Controls.Transmit_Mode)
                    {
                        ...
                        Smeter_controls.VU.VU_Value = BitConverter.ToInt32(message, 1);
                        //MonitorTextBoxText(" OnUdpData -> Smeter_controls.VU.VU_Value: " +
                        //      Convert.ToString(Smeter_controls.VU.VU_Value));
                        /*if (Smeter_controls.VU.VU_Value >= 2 && !Smeter_controls.ALC_Blink_Timer_Running)
                        {
                            ALC_Blink_timer1.Enabled = true;
                            Smeter_controls.ALC_Blink_Timer_Running = true;
                            MonitorTextBoxText(" ALC_Blink_timer1_Tick -> STARTED");
                        }*/
                    }
                    break;
                ...
                case Amplifier_Power_Controls.CMD_SET_POTENTIA_CALIBRATION:
                    ...
                    if (Amplifier_Power_Controls.Calibration_Value >= -99 &&
                        Amplifier_Power_Controls.Calibration_Value <= 4)
                    {
#if RPI
                        Solidus_Settings.Amplifier_Values.Power_Calibration = Amplifier_Power_Controls.Calibration_Value;
#else
                        AMP_Calibrate_hScrollBar1.Value = Amplifier_Power_Controls.Calibration_Value;
#endif
                    }
                    Power_calibration_label58.Text = "STEP: " + Convert.ToString(Amplifier_Power_Controls.Calibration_Value);
                ...
                case Amplifier_Power_Controls.CMD_GET_POTENTIA_TEMPERATURE:
                    ...
                    Amplifier_temperature_label58.Text = "PA: " + Convert.ToString(operand) + "°C";
                ...
                case Master_Controls.CMD_GET_MIA_STATUS:
                    ...
                    if (operand == 0)
                    {
                        Solidus_Settings.Mia_Status = false;
                        Master_Controls.QRP_Mode = true;
                    }
                    else
                    {
                        Solidus_Settings.Mia_Status = true;
                    }
                    Solidus_Settings.Mia_Status_Set = true;
                    Manage_Solidus_Status();
                    break;
                ...
                case Master_Controls.CMD_SET_PA_BYPASS:
                    ...
                    if (operand == 0)
                    {
                        ...
                        Main_QRP_button8.Text = "QRP";
                        Main_QRP_button8.BackColor = Color.Gainsboro;
                        Main_QRP_button8.ForeColor = Color.Black;
                    ...
                    {
                        Main_QRP_button8.Text = "QRO";
                        Main_QRP_button8.BackColor = Color.Red;
                        Main_QRP_button8.ForeColor = Color.White;
                        PA_vButton1.BackColor = Color.Red;
                        PA_vButton1.ForeColor = Color.White;
                        PA_vButton1.Text = "QRO";
                        Master_Controls.QRP_Mode = false;
                    }
                    Solidus_Settings.Tune_Power_Configured = true;
                    break;
                ...
                case Master_Controls.CMD_SET_DISPLAY_FREQ:
                    ...
                    MonitorTextBoxText(" CMD_SET_DISPLAY_FREQ RECIEVED. Freq : " + 
                                                            Convert.ToString(BitConverter.ToInt32(message, 1)));
                ...
                case IQ_Controls.IQ_OPERATION_COMPLETE:
                    switch (operand)
                    {
                        case 2:
                            break;
                        case 1:
                            IQ_Commit_button2.ForeColor = Color.White;
                            IQ_Commit_button2.Text = "APPLY";
                            IQ_Controls.IQ_Server_Calibrating = false;
                            MonitorTextBoxText(" IQ_OPERATION_COMPLETE RECIEVED. SUCCESS");
                            IQBD_Next_Band(1);
                            break;
                        case 0:
                            IQBD_Calibration_Failed();
                            MonitorTextBoxText(" IQ_OPERATION_COMPLETE RECIEVED. FAILED");
                            break;
                        default:
                            IQ_Commit_button2.ForeColor = Color.White;
                            IQ_Commit_button2.Text = "APPLY";
...
*/
                ...
                case Volume_Controls.CMD_SET_SPEAKER_VOLUME:
                    ...
                    Solidus_Settings.Volume_Settings.Speaker_Volume = speaker_value;
#if !RPI
                    ...
                    if (operand == 1)
                    {
                        ...
                        else
                        {
                            ...
                            if (Frequency_Calibration_controls.Reset)
                            {
                                ...
                                Frequency_Calibration_controls.Reset = false;
                                calibratebutton1.Text = "COURSE CALIBRATION COMPLETED\n\rFINE CALIBRATION RECOMMENDED";
                            }
                        }
                    }
                    else
                ...
                */
...
#if RPI
                        Solidus_Settings.Amplifier_Values.Power_Output = message[1];
#endif
                ...
                case oCode.CMD_GET_BAND_POWER:
                    ...
                    if (Power_Calibration_Controls.Factory_Defaults)
                    {
                        powerrestorebutton2.ForeColor = Color.Black;
...
*/
        ...
        /*public void Set_Favs()
        {
            if (Favorites_Controls.Current_Band != oCode.current_band)
            {
                switch (oCode.current_band)
                {
                    case 10:
        ...
        private void Left_Button_comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!Master_Controls.code_triggered)
            {
                ...
                if (Compare_Switches(Tuning_Knob_Controls.LEFT_SWITCH, index))
                {
                    ...
                    MonitorTextBoxText(" Left Button Star Position: 0x" +
                                        Tuning_Knob_Controls.Star_Position.Left.ToString("X"));
                    oCode.SendCommand(txsocket, txtarget, Tuning_Knob_Controls.CMD_SET_TRANSCEIVER_DISPLAY,
                        transceiver_display);
                    Tuning_Knob_Controls.previous_switch_table[Tuning_Knob_Controls.LEFT_SWITCH] = (sbyte)index;
                    buf[1] = (byte)index;
                    oCode.SendCommand_MultiByte(txsocket, txtarget,
        ...
        private void Middle_Button_comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!Master_Controls.code_triggered)
            {
                ...
                if (Compare_Switches(Tuning_Knob_Controls.MIDDLE_SWITCH, index))
                {
                    ...
                    MonitorTextBoxText(" Middle Button Star Position: 0x" +
                            Tuning_Knob_Controls.Star_Position.Middle.ToString("X"));
                    oCode.SendCommand(txsocket, txtarget, Tuning_Knob_Controls.CMD_SET_TRANSCEIVER_DISPLAY,
                        transceiver_display);
                    Tuning_Knob_Controls.previous_switch_table[Tuning_Knob_Controls.MIDDLE_SWITCH] = (sbyte)index;
                    buf[1] = (byte)index;
...
*/
        ...
        {
            if (oCode.isLoading == true) return;
            if (CW_Parameters.CW_Semi_Break_In == 0)
            {
                CW_Parameters.CW_Semi_Break_In = 1;
            }
            else
            {
                CW_Parameters.CW_Semi_Break_In = 0;
        ...
        /*private void txholdhScrollBar1_Scroll(object sender, ScrollEventArgs e)
{
    ...
    oCode.SendCommand(txsocket, txtarget, oCode.SET_TX_HOLD, (short)txholdhScrollBar1.Value);
        ...
        private void CW_Hold_numericUpDown2_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (txholdValue == CW_Parameters.CW_Tx_Hold) return;           // nothing happens if value doesn't change from previous

            CW_Parameters.CW_Tx_Hold = (short)txholdValue;
        ...
        /*private void Main_vuMeter1_Load_1(object sender, EventArgs e)
{
        ...
        {
            if (oCode.isLoading) return;
            DialogResult ret = MessageBox.Show("RESET WILL RESET THE FREQUENCY CALIBRATION\r\n" +
                "YES: RESET TO NO CALIBRATION\r\n" + "NO: USE DEFAULT CALIBRATION\r\n" +
                "DO YOU WISH TO PROCEDE? ", "MSCC", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Asterisk);
            if (ret == DialogResult.Yes || ret == DialogResult.No)
            {
                if (!Frequency_Calibration_controls.Calibration_In_Progress)
                {
                    if (!Frequency_Calibration_controls.standard_carrier_selected)
                    ...
                    Frequency_Calibration_controls.Frequency_Calibrated = 0;
                    Frequency_Calibration_controls.Display_Wait_count = 9;
                    Frequency_Calibration_controls.Display_Wait = true;
        ...
        /*private void Calibration_Progress_Bar_Click(object sender, EventArgs e)
{
        ...
        private void Power_Meter_Hold_ValueChanged_1(object sender, EventArgs e)
        {
            ...
            Solidus_Settings.Meter_Hold = index;
            buf[1] = (byte)index;
            oCode.SendCommand_MultiByte(txsocket, txtarget, Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND,
                buf, buf.Length);
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (ret == DialogResult.Yes)
            {
                ...
                Smeter_Timer.Stop();
                RPi_Display_Timer.Enabled = false;
                RPi_Display_Timer.Stop();
                Thread.Sleep(5);
                if (Solidus_Settings.RPi_Configured)
                {
                    Update_RPi_Settings();
                }
                if (Solidus_Settings.Shutdown == 0)
                {
                    if (Master_Controls.Initialize_network_status == true)
                    {
                        oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_STOP, 0);
                    }
                }
                else
                {
                    DialogResult shutdown_ret = MessageBox.Show("Shutdown Solidus?", "MSCC",
...
private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
{
        ...
        private void Time_checkBox2_CheckedChanged(object sender, EventArgs e)
        {
            if (Time_checkBox2.Checked == true)
            {
                ...
                UTC_Date_label46.Visible = true;
                Settings.Default.Time_Check_Box = true;
                Solidus_Settings.Time_Display = 1;
            }
            else
            {
                Time_display_label33.Visible = false;
                ...
                UTC_Date_label46.Visible = false;
                Settings.Default.Time_Check_Box = false;
                Solidus_Settings.Time_Display = 0;
            }
            //Solidus_Settings.RPi_Needs_Updated = true;
        }
        ...
        //******************* S Meter Routines ***************************************//
        private void ALC_ON_OFF_button5_Click(object sender, EventArgs e)
        {
            if (oCode.isLoading) return;
            if (AGC_ALC_Notch_Controls.ALC_STATE == false)
            {
                AGC_ALC_Notch_Controls.ALC_STATE = true;
                oCode.SendCommand(txsocket, txtarget, AGC_ALC_Notch_Controls.CMD_SET_ALC_MULTIPLIER, 0);
                Smeter_controls.VU.VU_Value = 0;
                Set_Button_Color(true, ALC_ON_OFF_button5, "ALC OFF");
            }
            else
            {
                AGC_ALC_Notch_Controls.ALC_STATE = false;
                oCode.SendCommand(txsocket, txtarget, AGC_ALC_Notch_Controls.CMD_SET_ALC_MULTIPLIER,
                                                                                (short)AGC_ALC_Notch_Controls.ALC_Value);
                Set_Button_Color(false, ALC_ON_OFF_button5, "ALC ON");
            }
        }
        private void ALC_Blink_timer1_Tick(object sender, EventArgs e)
        {
            int vu_display_value;

            vu_display_value = Smeter_controls.VU.VU_Value;
            if (Master_Controls.Transmit_Mode)
            {
                if (vu_display_value >= 2)
                {
                    if (Smeter_controls.ALC_Blink_Toggle)
                    {
                        Set_Button_Color(true, Meter_ALC_button8);
                        Smeter_controls.ALC_Blink_Toggle = false;
                    }
                    else
                    {
                        Set_Button_Color(false, Meter_ALC_button8);
                        Smeter_controls.ALC_Blink_Toggle = true;
                    }
                    if (vu_display_value >= 2 && vu_display_value <= 20)
                    {
                        ALC_Blink_timer1.Interval = 500;
                    }
                    else
                    {
                        if (vu_display_value >= 21 && vu_display_value <= 100)
                        {
                            ALC_Blink_timer1.Interval = 300;
                        }
                        else
                        {
                            if (vu_display_value >= 101)
                            {
                                ALC_Blink_timer1.Interval = 100;
                            }
                        }
                    }
                }
                ...
                {
                    if (Smeter_controls.mode != Smeter_controls.ALC_MODE)
                    {
                        Set_Button_Color(false, Meter_ALC_button8);
                    }
                }
        ...
        public void Initialize_Smeter()
        {
            ...
            Smeter_controls.Smeter.I_dial[0] = "6";
            Smeter_controls.Smeter.I_dial[1] = "8";
            Smeter_controls.Smeter.I_dial[2] = "10";
            Smeter_controls.Smeter.I_dial[3] = "12";
            Smeter_controls.Smeter.I_dial[4] = "14";
            Smeter_controls.Smeter.I_dial[5] = "16";
            Smeter_controls.Smeter.I_dial[6] = "18";
            Smeter_controls.Smeter.I_dial[7] = "20";

            Smeter_controls.Smeter.temperature_dial[0] = "10";
            Smeter_controls.Smeter.temperature_dial[1] = "20";
            Smeter_controls.Smeter.temperature_dial[2] = "30";
            Smeter_controls.Smeter.temperature_dial[3] = "40";
            Smeter_controls.Smeter.temperature_dial[4] = "50";
            Smeter_controls.Smeter.temperature_dial[5] = "60";
            Smeter_controls.Smeter.temperature_dial[6] = "70";
         }
        ...
        private void Set_Meter_Indicator(byte mode)
        {
            Reset_Meter_Buttons();
            switch (mode)
            {
                case Smeter_controls.POWER_MODE:
                    Set_Button_Color(true, Meter_Power_button8);
                    //Meter_Power_button8.Text = "P";
                    break;
                case Smeter_controls.SWR_MODE:
                    Set_Button_Color(true, Meter_SWR_button8);
                    //Meter_SWR_button8.Text = "S";
                    break;
                case Smeter_controls.ALC_MODE:
                    Set_Button_Color(true, Meter_ALC_button8);
                    //Meter_ALC_button8.Text = "A";
                    break;
                case Smeter_controls.I_MODE:
                    Set_Button_Color(true, Meter_I_button8);
                    //Meter_I_button8.Text = "I";
                    break;
                case Smeter_controls.TEMPERATURE_MODE:
                    Set_Button_Color(true, Meter_Temperature_button8);
                    //Meter_I_button8.Text = "I";
                    break;
            }
        }
        private bool Manage_Text_Display()
        {
            bool display_mode = false;
            if (Smeter_controls.Display_Mode == Smeter_controls.S_METER_MODE)
            {
                Dbm_Value_label9.Visible = true;
                Dbm_label9.Visible = true;
            ...
            {
                Dbm_Value_label9.Visible = false;
                Dbm_label9.Visible = false;
                Power_Value_label2.Visible = true;
                Power_Value_label2.Visible = true;
                display_mode = false;
            }
            MonitorTextBoxText(" Manage_Text_Display: display_mode: " + Convert.ToString(display_mode));
            return display_mode;
        }
        private void Set_Smeter_Label_Color(bool active,Label mylabel)
        {
            switch (active)
            {
                case true:
        ...
        {
            if (Smeter_controls.Display_Mode != Smeter_controls.mode)
            {
                MonitorTextBoxText(" Configure_Meter: Current_mode: " + 
                    Convert.ToString(Smeter_controls.Display_Mode) +
                    " Smeter_controls.mode:  " + Convert.ToString(Smeter_controls.mode));
                Smeter_controls.Display_Mode = Smeter_controls.mode;
                vuMeter1.Level = 0;
                Set_Smeter_Label_Color(false, Power_Value_label2);
                switch (Smeter_controls.mode)
                {
                    case Smeter_controls.POWER_MODE:
                        Smeter_controls.Display_Power_Value = true;
                        switch (Master_Controls.QRP_Mode)
                        {
                            case true:
                                ...
                                vuMeter1.DialTextNegative = Color.Red;
                                vuMeter1.DialTextPositive = Color.Black;
                            ...
                            default:
                                ...
                                vuMeter1.Led3Count = 2;
                                vuMeter1.LevelMax = Smeter_controls.Power_Meter_Max_Level;
                                vuMeter1.DialTextNegative = Color.Red;
                                vuMeter1.DialTextPositive = Color.Black;
                                vuMeter1.ResumeLayout();
                                break;
                    ...
                    case Smeter_controls.ALC_MODE:
                        ...
                        vuMeter1.DialTextNegative = Color.Black;
                        vuMeter1.DialTextPositive = Color.Red;
                        vuMeter1.ResumeLayout();
                        break;
                    case Smeter_controls.I_MODE:
                        vuMeter1.SuspendLayout();
                        vuMeter1.MeterScale = VU_MeterLibrary.MeterScale.Analog;
                        vuMeter1.VuText = "I (Amp)";
                        vuMeter1.TextInDial = Smeter_controls.Smeter.I_dial;
                        vuMeter1.Level = 0;
                        vuMeter1.Led1Count = 7;
                        vuMeter1.Led2Count = 0;
                        vuMeter1.Led3Count = 0;
                        vuMeter1.LevelMax = 22;
                        vuMeter1.DialTextNegative = Color.Red;
                        vuMeter1.DialTextPositive = Color.Black;
                        vuMeter1.ResumeLayout();
                        break;
                    case Smeter_controls.TEMPERATURE_MODE:
                        vuMeter1.SuspendLayout();
                        vuMeter1.MeterScale = VU_MeterLibrary.MeterScale.Analog;
                        vuMeter1.VuText = "TEMP °C";
                        vuMeter1.TextInDial = Smeter_controls.Smeter.temperature_dial;
                        vuMeter1.Level = 0;
                        vuMeter1.Led1Count = 4;
                        vuMeter1.Led2Count = 1;
                        vuMeter1.Led3Count = 2;
                        vuMeter1.LevelMax = 75;
                        vuMeter1.DialTextNegative = Color.Red;
                        vuMeter1.DialTextPositive = Color.Black;
                        vuMeter1.ResumeLayout();
                        break;
        ...
        private void Display_I_Value() {
            int I_value = 0;

            I_value = Smeter_controls.Meter_I_Value / 1000;
            if(I_value > 20)
            {
                I_value = 20;
            }
            vuMeter1.Level = I_value;
            Power_Value_label2.Text = Convert.ToString(Smeter_controls.Meter_I_Value) + " ma";
        }
        private void Display_ALC_Value()
        {
            ...
            if (Smeter_controls.Smeter_Hold_On)
            {
                ...
                {
                    Smeter_controls.VU.Previous_Low = Smeter_controls.VU.Previous_Low -
                        (Smeter_controls.Smeter_decrement + 10);
            ...
            if (vu_display_value >= 0)
            {
                ...
                if (power_display_value > 200)
                {
                    Set_Smeter_Label_Color(true, Power_Value_label2);
                }
                else
                {
                    Set_Smeter_Label_Color(false, Power_Value_label2);
        ...
        private void Display_Smeter_Value()
        {
            ...
            Dbm_Value_label9.Text = Convert.ToString(db_value);
        }
        private void Display_Power_Value()
        {
            vuMeter1.Level = Smeter_controls.Power_Value;
            //Power_Value_label2.Text = Convert.ToString(Smeter_controls.Power_Value) + " W";
            //MonitorTextBoxText(" Display_Power_Value: " + Convert.ToString(Smeter_controls.Power_Value));
        }
        private void Display_SWR_Value()
        {
            Smeter_controls.SWR_Fraction = (10 * (Math.Round(Smeter_controls.SWR_Value, 2)));
            Smeter_controls.SWR_Fraction_Part = (int)Smeter_controls.SWR_Fraction;
            if (Smeter_controls.SWR_Fraction_Part >= 10)
            {
                Smeter_controls.SWR_Fraction_Part = Smeter_controls.SWR_Fraction_Part - 10;
            }
            if (Smeter_controls.SWR_Fraction_Part > 20)
            {
                Smeter_controls.SWR_Fraction_Part = Smeter_controls.SWR_Fraction_Part - 20;
            }
            if (Smeter_controls.SWR_Fraction_Part > 30)
            {
                Smeter_controls.SWR_Fraction_Part = Smeter_controls.SWR_Fraction_Part - 30;
            }

            //MonitorTextBoxText(" SWR_Fraction: " + Convert.ToString(Smeter_controls.SWR_Fraction_Part));
            vuMeter1.Level = ((int)Smeter_controls.SWR_Value - 1) + Smeter_controls.SWR_Fraction_Part;
            //MonitorTextBoxText(" vuMeter1.Level: " + Convert.ToString(vuMeter1.Level));
            Power_Value_label2.Text = SWR_Value_label43.Text;
        }
        private void Display_Temperature_Value()
        {
            if (Master_Controls.QRP_Mode)
            {
                vuMeter1.Level = Smeter_controls.Proficio_temperature;
            }
            else
            {
                if (G_Potentia_Temparature_Average > 15)
                {
                    vuMeter1.Level = G_Potentia_Temparature_Average;
                }
            }
            Power_Value_label2.Text = Convert.ToString(vuMeter1.Level) + " °C";
        ...
        private void Smeter_Timer_Tick(object sender, EventArgs e)
        {
            if (!Master_Controls.Transmit_Mode)
            {
                if (Smeter_controls.Display_Mode != Smeter_controls.S_METER_MODE)
                {
                    Smeter_controls.Display_Power_Value = false;
                    vuMeter1.MeterScale = VU_MeterLibrary.MeterScale.Analog;
                    vuMeter1.SuspendLayout();
                    ...
                    Smeter_controls.Text_Display_Dbm_mode = Manage_Text_Display();
                }
            }
            else
            {
                if (Smeter_controls.Text_Display_Dbm_mode == true)
                {
                    Smeter_controls.Text_Display_Dbm_mode = Manage_Text_Display();
                }
                Configure_Meter();
            ...
            switch (Smeter_controls.Display_Mode)
            {
                case Smeter_controls.ALC_MODE:
                    Display_ALC_Value();
                    break;
        ...
        private void Peak_Needle_checkBox2_CheckedChanged(object sender, EventArgs e)
        {
            if (Peak_Needle_checkBox2.Checked)
            {
                vuMeter1.PeakHold = true;
                Settings.Default.Meter_Peak_Needle = true;
                Solidus_Settings.Peak_Needle = 1;
            }
            else
            {
                vuMeter1.PeakHold = false;
                Settings.Default.Meter_Peak_Needle = false;
                Solidus_Settings.Peak_Needle = 0;
            }
            //Solidus_Settings.RPi_Needs_Updated = true;
        }
        private void Peak_Needle_Delay_listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Solidus_Settings.Peak_Needle_Delay_Index = value;
            //Solidus_Settings.RPi_Needs_Updated = true;
        }
        private void Meter_Peak_Needle_Color_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Solidus_Settings.Peak_Needle_Color_Index = value;
            //Solidus_Settings.RPi_Needs_Updated = true;
        }
        private void Smeter_Average_button8_Click(object sender, EventArgs e)
        {
            if (oCode.isLoading) return;
            Smeter_controls.Smeter_Average++;
            if (Smeter_controls.Smeter_Average > 3)
            {
                Smeter_controls.Smeter_Average = 0;
            }
            switch (Smeter_controls.Smeter_Average)
            {
                case 0:
            ...
            oCode.SendCommand(txsocket, txtarget, Smeter_controls.CMD_SET_SMETER_AVERAGE, Smeter_controls.Smeter_Average);
        }
        ...
        private void Reset_Meter_Buttons()
        {
            Set_Button_Color(false, Meter_Power_button8);
            Set_Button_Color(false, Meter_SWR_button8);
            Set_Button_Color(false, Meter_I_button8);
            Set_Button_Color(false, Meter_ALC_button8);
            Set_Button_Color(false, Meter_Temperature_button8);
        }
        private void Meter_Power_button8_Click(object sender, EventArgs e)
        {
            Smeter_controls.mode = Smeter_controls.POWER_MODE;
            Solidus_Settings.Meter_Mode = Smeter_controls.mode;
            Reset_Meter_Buttons();
            Set_Button_Color(true, Meter_Power_button8);
        }
        private void Meter_SWR_button8_Click(object sender, EventArgs e)
        {
            Smeter_controls.mode = Smeter_controls.SWR_MODE;
            //Set_Meter_Indicator(Smeter_controls.mode);
            Solidus_Settings.Meter_Mode = Smeter_controls.mode;
            Reset_Meter_Buttons();
            Set_Button_Color(true, Meter_SWR_button8);
        }
        private void Meter_I_button8_Click(object sender, EventArgs e)
        {
            Smeter_controls.mode = Smeter_controls.I_MODE;
            //Set_Meter_Indicator(Smeter_controls.mode);
            Solidus_Settings.Meter_Mode = Smeter_controls.mode;
            Reset_Meter_Buttons();
            Set_Button_Color(true, Meter_I_button8);
        }
        private void Meter_ALC_button8_Click(object sender, EventArgs e)
        {
            Smeter_controls.mode = Smeter_controls.ALC_MODE;
            //Set_Meter_Indicator(Smeter_controls.mode);
            Solidus_Settings.Meter_Mode = Smeter_controls.mode;
            Reset_Meter_Buttons();
            Set_Button_Color(true, Meter_ALC_button8);
        }
        private void Meter_Temperature_button8_Click(object sender, EventArgs e)
        {
            Smeter_controls.mode = Smeter_controls.TEMPERATURE_MODE;
            //Set_Meter_Indicator(Smeter_controls.mode);
            Solidus_Settings.Meter_Mode = Smeter_controls.mode;
            Reset_Meter_Buttons();
            Set_Button_Color(true, Meter_Temperature_button8);
        ...
        private void IQBD_ONOFF_Click(object sender, EventArgs e)
        {
            ...
            {
                _ = MessageBox.Show("Select a Band", "MSCC", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
            }
        ...
        private void IQBD_hScrollBar2_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            if (IQ_Controls.Tune_power == (short)value) return;
            IQ_Controls.Tune_power = (short)value;
            IQBD_Calibrate_Power_label9.Text = Convert.ToString(IQ_Controls.Tune_power);
            oCode.SendCommand(txsocket, txtarget, Power_Controls.CMD_SET_TUNE_POWER, (short)value);
        }
        ...
        private void IQBD_Monitor_label_Click(object sender, EventArgs e)
        {
        ...
        private void IQBD_Next_Band(int status)
        {
            byte[] buf = new byte[2];

            MonitorTextBoxText(" IQBD_Next_Band. Status: " + Convert.ToString(status));
            buf[0] = Master_Controls.Extended_Commands.CMD_SET_IQBD_MONITOR;
            IQBD_Manage_TX(false);
            Thread.Sleep(10);
            IQBD_Calibrate_Band(0, false);
            IQ_Controls.IQ_Server_Calibrating = false;
            IQ_Controls.Cool_Down = 0;
            IQBD_Auto_button8.Text = "I/Q CALIBRATE";
            Set_Button_Color(false, IQBD_Auto_button8);
            IQ_Controls.Calibrating = false;
            AMP_groupBox3.Enabled = true;
            AMP_groupBox3.ForeColor = Color.White;
            //IQBD_Monitor_label.Text = "0";
            oCode.SendCommand(txsocket, txtarget, IQ_Controls.IQ_CALIBRATION_RX_TX, 0);
            buf[1] = 0;
            oCode.SendCommand_MultiByte(txsocket, txtarget,
                                    Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND, buf, buf.Length);
        ...
        private void IQBD_Manage_Calibrate(int band, bool start)
        {
            byte[] buf = new byte[2];
            buf[0] = Master_Controls.Extended_Commands.CMD_SET_IQBD_MONITOR;
            if (start)
        ...
        private void IQBD_Manage_TX(bool on_off)
        {
            switch (on_off)
            {
                case true:
        ...
        private void IQBD_Auto_button8_Click(object sender, EventArgs e)
        {
            if (Amplifier_Power_Controls.PA_Band_Selected)
            {
                if (IQ_Controls.Calibrating == false)
                {
                    DialogResult ret = MessageBox.Show("     START THE IQBD CALIBRATION? " + "\r\n     THIS WILL TAKE A WHILE" +
                        "\r\n   ABOUT 6  MINUTES PER BAND" + "\r\n    PLEASE BE PATIENT", 
                        "MSCC", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    if (ret == DialogResult.Yes)
                    {
                        Set_Button_Color(true, IQBD_Auto_button8);
                        IQ_Controls.Calibrating = true;
                        AMP_groupBox3.Enabled = false;
                        oCode.SendCommand(txsocket, txtarget, Master_Controls.CMD_SET_PA_BYPASS, 0);
                        IQBD_Manage_Calibrate(IQ_Controls.Calibration_Band_Count, true);
                        AMP_groupBox3.ForeColor = Color.Red;
                        Calibration_Band_button8.Enabled = false;
                        IQBD_Monitor_label.Text = "0";
                    }
                ...
                {
                    _ = MessageBox.Show("IQBD CALIBRATION RUNNING. PRESS CANCEL BUTTON TO STOP CALIBRATION", "MSCC",
                       MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            else
            {
                _ = MessageBox.Show("SELECT A CALIBRATION BAND", "MSCC",
                       MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        private void IQBD_Set_Band(int band)
        {
            switch (band)
            {
                case 0:
                    oCode.SendCommand(txsocket, txtarget, IQ_Controls.CMD_SET_IQ_BAND, IQ_Controls.B160);
                    IQBD_Auto_button8.Text = "160M CALIBRATING";
                    break;
                case 1:
                    oCode.SendCommand(txsocket, txtarget, IQ_Controls.CMD_SET_IQ_BAND, IQ_Controls.B80);
                    IQBD_Auto_button8.Text = "80M CALIBRATING";
                    break;
                case 2:
                    oCode.SendCommand(txsocket, txtarget, IQ_Controls.CMD_SET_IQ_BAND, IQ_Controls.B60);
                    IQBD_Auto_button8.Text = "60M CALIBRATING";
                    break;
                case 3:
                    oCode.SendCommand(txsocket, txtarget, IQ_Controls.CMD_SET_IQ_BAND, IQ_Controls.B40);
                    IQBD_Auto_button8.Text = "40M CALIBRATING";
                    break;
                case 4:
                    oCode.SendCommand(txsocket, txtarget, IQ_Controls.CMD_SET_IQ_BAND, IQ_Controls.B30);
                    IQBD_Auto_button8.Text = "30M CALIBRATING";
                    break;
                case 5:
                    oCode.SendCommand(txsocket, txtarget, IQ_Controls.CMD_SET_IQ_BAND, IQ_Controls.B20);
                    IQBD_Auto_button8.Text = "20M CALIBRATING";
                    break;
                case 6:
                    oCode.SendCommand(txsocket, txtarget, IQ_Controls.CMD_SET_IQ_BAND, IQ_Controls.B17);
                    IQBD_Auto_button8.Text = "17M CALIBRATING";
                    break;
                case 7:
                    oCode.SendCommand(txsocket, txtarget, IQ_Controls.CMD_SET_IQ_BAND, IQ_Controls.B15);
                    IQBD_Auto_button8.Text = "15M CALIBRATING";
                    break;
                case 8:
                    oCode.SendCommand(txsocket, txtarget, IQ_Controls.CMD_SET_IQ_BAND, IQ_Controls.B12);
                    IQBD_Auto_button8.Text = "12M CALIBRATING";
                    break;
                case 9:
                    oCode.SendCommand(txsocket, txtarget, IQ_Controls.CMD_SET_IQ_BAND, IQ_Controls.B10);
                    IQBD_Auto_button8.Text = "10M CALIBRATING";
                    break;
                default:
                    break;
            }
        }
        private void IQBD_Calibrate_Band(int band, bool start)
        {
            byte[] buf = new byte[2];
            buf[0] = Master_Controls.Extended_Commands.CMD_SET_IQBD_MONITOR;
            if (start)
        ...
        private void IQBD_Calibration_Failed()
        {
            oCode.SendCommand(txsocket, txtarget, IQ_Controls.IQ_CALIBRATION_RX_TX, 0);
            IQBD_Manage_TX(false);
            Thread.Sleep(10);
            IQBD_Calibrate_Band(0, false);
            IQ_Controls.Calibration_Band_Count = 0;
            IQ_Controls.IQ_Server_Calibrating = false;
            IQ_Controls.Cool_Down = 0;
            IQBD_Auto_button8.Text = "CALIBRATION FAILED";
            AMP_groupBox3.Enabled = true;
            AMP_groupBox3.ForeColor = Color.White;
            Calibration_Band_button8.Enabled = true;
        }
        private void IQBD_Cancel_button8_Click(object sender, EventArgs e)
        {
            byte[] buf = new byte[2];
            buf[0] = Master_Controls.Extended_Commands.CMD_SET_IQBD_MONITOR;
            IQBD_Manage_TX(false);
        ...
        public void Manage_Solidus_Status()
        {
            ...
            if (Solidus_Settings.Solidus_Status_Set && Solidus_Settings.Mia_Status_Set)
            {
                MonitorTextBoxText(" Manage_Solidus_Status -> Solidus_Status: " +
                    Convert.ToString(Solidus_Settings.Solidus_Status));
                if (Solidus_Settings.Solidus_Status)
                {
                    IQBD_groupBox4.Enabled = true;
                    //IQ_groupBox3.Enabled = false;
                    IQ_TX_button.Enabled = false;
                    AMP_groupBox3.Enabled = true;
                }
                else
                {
                    IQBD_groupBox4.Enabled = false;
                    IQ_TX_button.Enabled = true;
                    //IQ_groupBox3.Enabled = true;
                    AMP_groupBox3.Enabled = false;
                }
                MonitorTextBoxText(" Manage_Solidus_Status -> Mia_Status: " +
                    Convert.ToString(Solidus_Settings.Mia_Status));
                if (!Solidus_Settings.Mia_Status)
                {
                    PA_vButton1.Enabled = false;
                    PA_vButton1.Text = "QRP";
            ...
            else
            {
                MonitorTextBoxText(" Manage_Solidus_Status -> Status NOT Set -> Solidus_status_Set: " +
                    Convert.ToString(Solidus_Settings.Solidus_Status_Set) +
                    " Mia_Status_Set: " + Convert.ToString(Solidus_Settings.Mia_Status_Set));
            }
        }
        ...
        /*private void Solidus_Function_Buttons_Enter(object sender, EventArgs e)
{
        ...
        private void Step_button8_Click(object sender, EventArgs e)
        {
            ...
            oCode.Freq_Tune_Index = (short)Master_Controls.Step_Index;
            oCode.SendCommand(txsocket, txtarget, Tuning_Knob_Controls.CMD_SET_STEP_VALUE, oCode.Freq_Tune_Index);
            oCode.FreqDigit = (short)Swap_tuning_step(oCode.Freq_Tune_Index);
            Set_Freq_Digit_Pointer();
        }
        private void Shutdown_checkBox2_CheckedChanged(object sender, EventArgs e)
        {
            if (Shutdown_checkBox2.Checked)
            {
                Solidus_Settings.Shutdown = 1;
            }
            else
            {
                Solidus_Settings.Shutdown = 0;
            }
        }
        private void Display_High_Cut_Value()
        {
            switch (Filter_control.Filter_High_Index)
            {
                case 4:
        ...
        private void High_Cut_Filter_button8_Click(object sender, EventArgs e)
        {
            {
        ...
        private void Display_Low_Cut_Value()
        {
            switch (Filter_control.Filter_Low_Index)
            {
                case 4:
        ...
        private void Display_CW_Value()
        {
            switch (Filter_control.CW_Filter_Index)
            {
                case 0:
        ...
        private void Meter_Mode_label9_Click(object sender, EventArgs e)
        {

        }
        private void Meter_Background_listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            int value;
            value = Meter_Background_listBox1.SelectedIndex;
            //Settings.Default.Meter_Peak_Needle_Color = (byte)value;
            switch (value)
            {
                case 0:
                    vuMeter1.DialBackground = Color.Moccasin;
                    break;
                case 1:
                    vuMeter1.DialBackground = Color.Coral;
                    break;
                case 2:
                    vuMeter1.DialBackground = Color.Tomato;
                    break;
                case 3:
                    vuMeter1.DialBackground = Color.Orange;
                    break;
                case 4:
                    vuMeter1.DialBackground = Color.Blue;
                    break;
                case 5:
                    vuMeter1.DialBackground = Color.Green;
                    break;
                case 6:
                    vuMeter1.DialBackground = Color.Yellow;
                    break;
                case 7:
                    vuMeter1.DialBackground = Color.White;
                    break;
                case 8:
                    vuMeter1.DialBackground = Color.Red;
                    break;
            }
            Solidus_Settings.Meter_Background_Color_Index = value;
        }
        private void Antenna_Indicator_button8_Click(object sender, EventArgs e)
        {
        ...
        private void Dbm_Value_label9_Click(object sender, EventArgs e)
        {

        }
        private void Dbm_label9_Click(object sender, EventArgs e)
        {
        ...
        private void Standard_Carrier_button8_Click(object sender, EventArgs e)
        {
            Int32 fr = 0;
            short mode_number;
            ...
            if (!Master_Controls.Transceiver_Warming)
            {
                MonitorTextBoxText(" Standard_Carrier_button8_Click -> Called.");
                calibratebutton1.Text = "CALIBRATE";
                calibratebutton1.BackColor = Color.Gainsboro;
                calibratebutton1.ForeColor = Color.Black;
                Calibration_progressBar1.Value = 0;
                ...
                Freq_Cal_checkBox3.Visible = true;
                Frequency_Calibration_controls.standard_carrier_selected = true;
                switch (Frequency_Calibration_controls.Standard_carrier_selected_index)
                {
                    case 0:
                        fr = 2500000;
                        break;
                ...
                Standard_Carrier_button8.Text = Convert.ToString(fr);
                Frequency_Calibration_controls.standard_carrier_selected = true;
                Frequency_Calibration_controls.Calibration_frequency = fr;
                Frequency_Calibration_controls.Display_Wait = true;
                ...
                MonitorTextBoxText(" Standard_Carrier_button8_Click -> Finished.");
            }
            else
            {
                MessageBox.Show("Transceiver is in Warm Up Mode. Try again later after warm up is complete", "MSCC",
        ...
        private void Mic_Pre_Gain_button8_Click(object sender, EventArgs e)
        {
            if (oCode.isLoading) return;
            Solidus_Settings.Volume_Settings.Mic_Pre_Gain++;
            if (Solidus_Settings.Volume_Settings.Mic_Pre_Gain > 5)
            {
                Solidus_Settings.Volume_Settings.Mic_Pre_Gain = 0;
            }
            Mic_Pre_Gain_button8.Text = Convert.ToString(Solidus_Settings.Volume_Settings.Mic_Pre_Gain);
            oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_MIC_GAIN,
                                                                    (short)Solidus_Settings.Volume_Settings.Mic_Pre_Gain);
        ...
        {
            Solidus_Settings.Volume_Settings.Volume_ATTN_Index++;
            if (Solidus_Settings.Volume_Settings.Volume_ATTN_Index > 5)
            {
                Solidus_Settings.Volume_Settings.Volume_ATTN_Index = 0;
            }
            Volume_Attn_button8.Text = Convert.ToString(Solidus_Settings.Volume_Settings.Volume_ATTN_Index);
            if (!Solidus_Settings.Volume_Settings.Mic_Is_Digital)
            {
        ...
        private void IQBD_Reset_button8_Click(object sender, EventArgs e)
        {
            DialogResult ret = MessageBox.Show("THIS RESETS ALL I/Q VALUES TO FACTORY VALUES. \r\nARE YOU SURE YOU WANT TO CONTINUE?",
                "MSCC", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk);
            if (ret == DialogResult.Yes)
            {
                oCode.SendCommand(txsocket, txtarget, IQ_Controls.IQ_CALIBRATION_RX_TX, 1);
        ...
        private void Main_QRP_button8_Click(object sender, EventArgs e)
        {
            if (Solidus_Settings.Mia_Status)
            {
                if (!Master_Controls.Transmit_Mode)
                {
                    if (Master_Controls.QRP_Mode)
                    {
                        ...
                        Tune_Power_label37.Text = Convert.ToString(Power_Controls.TUNE_Power);
                        Tune_Power_hScrollBar1.Value = Power_Controls.TUNE_Power;
                        MonitorTextBoxText(" Main_QRP_button8_Click -> Set QRO Mode " + "Power_Controls.TUNE_Power: " +
                            Convert.ToString(Power_Controls.TUNE_Power));
                    }
                    else
                    {
                        ...
                        Tune_Power_hScrollBar1.Value = Solidus_Settings.QRP_Tune_Power;
                        oCode.SendCommand(txsocket, txtarget, Master_Controls.CMD_SET_PA_BYPASS, 0);
                        MonitorTextBoxText(" Main_QRP_button8 -> Set QRP Mode");
                    }
                }
            }
            else
        ...
        private void Calibration_Band_button8_Click(object sender, EventArgs e)
        {
            int Power_Value = 100;
            if (oCode.isLoading) return;

            IQ_Controls.Calibration_Band_Count++;
            if (IQ_Controls.Calibration_Band_Count > 9)
            {
                IQ_Controls.Calibration_Band_Count = 0;
            }
            switch (IQ_Controls.Calibration_Band_Count)
            {
                case 0:
                    Amplifier_Power_Controls.Band = 160;
                    Calibration_Band_button8.Text = "160M";
                    AMP_label57.Text = "160M";
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B160.Freq);
                    break;
                case 1:
                    Amplifier_Power_Controls.Band = 80;
                    Calibration_Band_button8.Text = "80M";
                    AMP_label57.Text = "80M";
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B80.Freq);
                    break;
                case 2:
                    Amplifier_Power_Controls.Band = 60;
                    Calibration_Band_button8.Text = "60M";
                    AMP_label57.Text = "60M";
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B60.Freq);
                    break;
                case 3:
                    Amplifier_Power_Controls.Band = 40;
                    Calibration_Band_button8.Text = "40M";
                    AMP_label57.Text = "40M";
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B40.Freq);
                    break;
                case 4:
                    Amplifier_Power_Controls.Band = 30;
                    Calibration_Band_button8.Text = "30M";
                    AMP_label57.Text = "30M";
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B30.Freq);
                    break;
                case 5:
                    Amplifier_Power_Controls.Band = 20;
                    Calibration_Band_button8.Text = "20M";
                    AMP_label57.Text = "20M";
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B20.Freq);
                    break;
                case 6:
                    Amplifier_Power_Controls.Band = 17;
                    Calibration_Band_button8.Text = "17M";
                    AMP_label57.Text = "17M";
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B17.Freq);
                    break;
                case 7:
                    Amplifier_Power_Controls.Band = 15;
                    Calibration_Band_button8.Text = "15M";
                    AMP_label57.Text = "15M";
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B15.Freq);
                    break;
                case 8:
                    Amplifier_Power_Controls.Band = 12;
                    Calibration_Band_button8.Text = "12M";
                    AMP_label57.Text = "12M";
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B12.Freq);
                    break;
                case 9:
                    Amplifier_Power_Controls.Band = 10;
                    Calibration_Band_button8.Text = "10M";
                    AMP_label57.Text = "10M";
                    oCode.SendCommand32(txsocket, txtarget, oCode.CMD_SET_MAIN_FREQ, Last_used.B10.Freq);
                    break;
            }
            ...
            oCode.SendCommand(txsocket, txtarget, Amplifier_Power_Controls.CMD_SET_AMPLIFIER_POWER,
                                                                            (short)Power_Value);
            Amplifier_Power_Controls.PA_Band_Selected = true;
        }
        private void Antenna_Switch_button8_Click(object sender, EventArgs e)
        {
            byte[] buf = new byte[2];
            if (oCode.isLoading) return;

            buf[0] = Master_Controls.Extended_Commands.CMD_SET_ANTENNA_SWITCH;
            Solidus_Settings.Antenna_Switch++;
            if (Solidus_Settings.Antenna_Switch > 9)
            {
                Solidus_Settings.Antenna_Switch = 0;
            }
            switch (Solidus_Settings.Antenna_Switch)
            {
                case 0:
            ...
            buf[1] = Set_Antenna_Switch_Value(Solidus_Settings.Antenna_Switch);
            MonitorTextBoxText(" Antenna_Switch_button8_Click: " +
               Convert.ToString(Solidus_Settings.Antenna_Switch));
            oCode.SendCommand_MultiByte(txsocket, txtarget,
                   Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND, buf, buf.Length);
           
        }
        /*private void ALC_label9_Click(object sender, EventArgs e)
        {

        }*/
        /*private void ALC_VALUE_label_Click(object sender, EventArgs e)
        {

        }*/
        private void PA_Display_Power_Timer_Tick(object sender, EventArgs e)
        {
            Solidus_Tab_Power_Display_label33.Text = "PA Power: " + Convert.ToString(Amplifier_Power_Controls.PA_Power);
        }
        private void PA_TX_button8_Click(object sender, EventArgs e)
        {
            short power = 0;
            short mode_number = 0;
            short tx_power = 100;
            ...
            // Tune button clicked
            MonitorTextBoxText(" PA_TX_button8_Click Entered ");
            if (!Master_Controls.TX_Inhibited)
            {
                if (Amplifier_Power_Controls.PA_Band_Selected)
                {
                    ...
                    if (Master_Controls.Tuning_Mode == false)
                    {
                        ...
                        oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, Mode.TUNE_MODE);
                        oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_RIG_TUNE, 1);
                        PA_Auto_Calibrate_button8.Enabled = false;
                        Set_Button_Color(true, PA_TX_button8);
                        Amplifier_Power_Controls.PA_Calibrating = true;
                        Master_Controls.Tuning_Mode = true;
                        Master_Controls.Transmit_Mode = true;
                        AM_Carrier_hScrollBar1.Enabled = false;
                        Power_hScrollBar1.Enabled = false;
                        ...
                        IQBD_groupBox4.Enabled = false;
                        Solidus_Bias_button8.Enabled = false;
                        Calibration_Band_button8.Enabled = false;
                        Antenna_Switch_button8.Enabled = false;
                        PA_Reset_button8.Enabled = false;

                        //Volume_Controls.Previous_Slider_Mode = Volume_Controls.Volume_Slider_Mode;
                        //Volume_Controls.Volume_Slider_Mode = Volume_Controls.SLIDER_TUNE_MODE;
                        Band_groupBox6.Enabled = false;
                        Main_QRP_button8.Enabled = false;
                        PA_Display_Power_Timer.Enabled = true;
                        PA_Display_Power_Timer.Start();
                    }
                    else
                    {
                        if (!Settings.Default.Speaker_MutED)
                        ...
                        MonitorTextBoxText(" Tune -> Current Band: " + oCode.current_band +
                            " Current Mode Number: " + mode_number);
                        oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, mode_number);
                        PA_Auto_Calibrate_button8.Enabled = true;
                        Set_Button_Color(false, PA_TX_button8);
                        Master_Controls.Tuning_Mode = false;
                        Master_Controls.Transmit_Mode = false;
                        AM_Carrier_hScrollBar1.Enabled = true;
            ...
            MonitorTextBoxText(" PA_TX_button8_Click -> finished ");
        }
        private bool PA_Check_Proficio_Calibration(int band)
        {
            bool calibrated = false;
            byte band_calibrated = 0;
            switch (band)
            {
                case 160:
                    band_calibrated = Power_Calibration_Controls.Calibrated_Bands.B_160;
                    break;
                case 80:
                    band_calibrated = Power_Calibration_Controls.Calibrated_Bands.B_80;
                    break;
                case 60:
                    band_calibrated = Power_Calibration_Controls.Calibrated_Bands.B_60;
                    break;
                case 40:
                    band_calibrated = Power_Calibration_Controls.Calibrated_Bands.B_40;
                    break;
                case 30:
                    band_calibrated = Power_Calibration_Controls.Calibrated_Bands.B_30;
                    break;
                case 20:
                    band_calibrated = Power_Calibration_Controls.Calibrated_Bands.B_20;
                    break;
                case 17:
                    band_calibrated = Power_Calibration_Controls.Calibrated_Bands.B_17;
                    break;
                case 15:
                    band_calibrated = Power_Calibration_Controls.Calibrated_Bands.B_15;
                    break;
                case 12:
                    band_calibrated = Power_Calibration_Controls.Calibrated_Bands.B_12;
                    break;
                case 10:
                    band_calibrated = Power_Calibration_Controls.Calibrated_Bands.B_10;
                    break;
            }
            if(band_calibrated == 1)
            {
                calibrated = true;
            }
            return calibrated;
        }
        private void PA_Calibrate_Timer_Tick(object sender, EventArgs e)
        {
            short power = 0;
            short mode_number = 0;

            Amplifier_Power_Controls.PA_Calibration_Increment++;
            Power_calibration_label58.Text = "STEP: " + Convert.ToString(Amplifier_Power_Controls.PA_Calibration_Increment);
            oCode.SendCommand32(txsocket, txtarget, Amplifier_Power_Controls.CMD_SET_POTENTIA_CALIBRATION,
                    Amplifier_Power_Controls.PA_Calibration_Increment);

            MonitorTextBoxText(" PA_Calibrate_Timer_Tick -> Amplifier_Power_Controls.PA_Power: " + Amplifier_Power_Controls.PA_Power);

            Solidus_Tab_Power_Display_label33.Text = "PA Power: " + Convert.ToString(Amplifier_Power_Controls.PA_Power);
            //+ "." + lower.ToString("D2");

            if (Amplifier_Power_Controls.PA_Power >= Amplifier_Power_Controls.PA_CALIBRATION_POWER_LIMIT)
            {
                MonitorTextBoxText(" PA_Calibrate_Timer_Tick -> Amplifier_Power_Controls.PA_Power: " +
                    Amplifier_Power_Controls.PA_Power);
                Amplifier_Power_Controls.PA_Calibrated_Value = Amplifier_Power_Controls.PA_Power;
                PA_Auto_Calibrate_button8.Text = "CALIBRATED";
                Set_Button_Color(false, PA_Auto_Calibrate_button8);
                Amplifier_Power_Controls.PA_Calibrated = true;
                Master_Controls.Tuning_Mode = false;
                if (!Settings.Default.Speaker_MutED)
                {
                    oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_SPEAKER_MUTE, 0);
                ...
                power = get_previous_power(oCode.current_band);
                mode_number = Convert_mode_char_to_digit(Last_used.Current_mode);
                MonitorTextBoxText(" PA_Calibrate_Timer_Tick -> Current Band: " + oCode.current_band +
                    " Current Mode Number: " + mode_number);
                oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, mode_number);
                buttTune.BackColor = Color.Gainsboro;
                buttTune.ForeColor = Color.Black;
                ...
                Calibration_Band_button8.Enabled = true;
                Antenna_Switch_button8.Enabled = true;
                Solidus_Tab_Power_Display_label33.Text = "PA Power: " + Convert.ToString(Amplifier_Power_Controls.PA_Calibrated_Value);
                PA_Reset_button8.Enabled = true;
                Amplifier_Power_Controls.PA_Calibrating = false;
                PA_Calibrate_Timer.Enabled = false;
                PA_Calibrate_Timer.Stop();
            }
            else
            {
                if(Amplifier_Power_Controls.PA_Calibration_Increment > Amplifier_Power_Controls.PA_MAX_CALIBRATION_COUNT)
                {
                    PA_Auto_Calibrate_button8.Text = "CALIBRATE";
                    Amplifier_Power_Controls.PA_Calibrating = false;
                    Set_Button_Color(false, PA_Auto_Calibrate_button8);
                    ...
                    PA_Calibrate_Timer.Enabled = false;
                    PA_Calibrate_Timer.Stop();
                    MessageBox.Show("COULD NOT ACHIEVE 100 WATTS FOR THIS BAND.  CHECK PROFICIO OUTPUT POWER", "MSCC",
                            MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                }
            }
        }
        private void PA_Auto_Calibrate_button8_Click(object sender, EventArgs e)
        {
            short power = 0;
            short mode_number = 0;
            MonitorTextBoxText(" PA_Auto_Calibrate_button8_Click Pressed ");
            if (Amplifier_Power_Controls.PA_Band_Selected)
            {
                if (!Master_Controls.TX_Inhibited)
                {
                    if (Master_Controls.Tuning_Mode == false)
                    {
                        //DialogResult ret = MessageBox.Show("HAS THE PROFICIO OUTPUT POWER BEEN CALIBRATED FOR THIS BAND?", "MSCC",
                        //    MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk);
                        if (PA_Check_Proficio_Calibration(Amplifier_Power_Controls.Band))
                        {
                            Amplifier_Power_Controls.PA_Not_Calibrated_Count = 0;
                            Amplifier_Power_Controls.PA_Calibrating = true;
                            oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_SPEAKER_MUTE, 1);
                            oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_MAIN_MODE, Mode.TUNE_MODE);
                            oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_RIG_TUNE, 1);
                            //PA_Auto_Calibrate_button8.Text = "CALIBRATING";
                            Amplifier_Power_Controls.PA_Calibrated = false;
                            Set_Button_Color(true, PA_Auto_Calibrate_button8,"CALIBRATING");
                            ...
                            Antenna_Switch_button8.Enabled = false;
                            PA_Reset_button8.Enabled = false;
                            Amplifier_Power_Controls.PA_Calibration_Increment = -99;
                            oCode.SendCommand32(txsocket, txtarget, Amplifier_Power_Controls.CMD_SET_POTENTIA_CALIBRATION,
                                                                            Amplifier_Power_Controls.PA_Calibration_Increment);
                            PA_Calibrate_Timer.Start();
                        }
                        else
                        {
                            MessageBox.Show("THE PROFICIO HAS NOT BEEN CALIBRATED FOR THIS BAND", "MSCC",
                                                        MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                        }
                    }
                    else
                    {
                        ...
                        PA_Reset_button8.Enabled = true;
                        //PA_Auto_Calibrate_button8.Text = "CALIBRATE";
                        Set_Button_Color(false, PA_Auto_Calibrate_button8,"CALIBRATE");
                        oCode.SendCommand32(txsocket, txtarget, Amplifier_Power_Controls.CMD_SET_POTENTIA_CALIBRATION,-99);
                        if (Amplifier_Power_Controls.PA_Calibrated == false)
                        {
                            MessageBox.Show("CALIBRATION TERMINATED.  THE CURRENT BAND IS NOT CALIBRATED", "MSCC", MessageBoxButtons.OK,
                                MessageBoxIcon.Asterisk);
                        }
                    }
                }
            ...
            MonitorTextBoxText(" PA_Auto_Calibrate_button8_Click -> finished ");
        }
        private void PA_Reset_button8_Click(object sender, EventArgs e)
        {
            DialogResult ret = MessageBox.Show("THIS RESETS POWER AMPLIFIER CALIBRATION FOR ALL BANDS TO FACTORY DEFAULTS" + 
                "\r\n                                            CONTINUE?", "MSCC", 
                MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk);
            if(ret == DialogResult.Yes)
            {
                oCode.SendCommand(txsocket, txtarget, Amplifier_Power_Controls.CMD_SET_AMPLIFIER_CALIBRATION_RESET, 1);
            }
        }
        private void Proficio_Calibrate_timer_Tick(object sender, EventArgs e)
        {
            int lower = 0;
            MonitorTextBoxText("Proficio_Calibrate_timer_Tick -> Upper: " + 
                Convert.ToString(Power_Calibration_Controls.Calibration_Power_Watts) + " Lower: " +
                Convert.ToString(Power_Calibration_Controls.Calibration_Power_Watts_Decimal));

            lower = Power_Calibration_Controls.Calibration_Power_Watts_Decimal;
            if (Power_Calibration_Controls.Calibration_Power_Watts_Decimal >= 100)
            {
                lower = Power_Calibration_Controls.Calibration_Power_Watts_Decimal / 10;
            }else
            {
                if(Power_Calibration_Controls.Calibration_Power_Watts_Decimal >= 1000)
                {
                    lower = Power_Calibration_Controls.Calibration_Power_Watts_Decimal / 100;
                }
            }

            XCRV_Power_Display_label33.Text = "POWER OUTPUT: " + Convert.ToString(Power_Calibration_Controls.Calibration_Power_Watts)
                + "." + lower.ToString("D");

            if (Power_Calibration_Controls.Calibration_Power_Watts >= Power_Calibration_Controls.CALIBRATION_MAX_POWER
                && Power_Calibration_Controls.Calibration_Power_Watts_Decimal >= 
                                                    Power_Calibration_Controls.CALIBRATION_MAX_POWER_DECIMAL)
            {                
                Proficio_Calibrate_button8.Text = "CALIBRATED";
                XCRV_Power_Display_label33.Text = "POWER OUTPUT: " + 
                    Convert.ToString(Power_Calibration_Controls.Calibration_Power_Watts)
               + "." + lower.ToString("D");
                Set_Button_Color(false, Proficio_Calibrate_button8);
                powerrestorebutton2.Enabled = true;
                Power_Calibration_Controls.Tuning_Mode = false;
                oCode.SendCommand(txsocket, txtarget, Power_Calibration_Controls.CMD_CALIBRATION_TUNE, 0);
                Set_Button_Color(false, powertunebutton1);
                powertunebutton1.Enabled = true;
                Proficio_Pwr_groupBox6.Enabled = true;
                powerrestorebutton2.Enabled = true;
                Master_Controls.Transmit_Mode = false;
                Power_Calibration_Controls.Calibrating = false;
                Proficio_Set_Band_Calibrated(1, (short)Power_Calibration_Controls.Band);
                Proficio_Calibrate_timer.Enabled = false;
                Proficio_Calibrate_timer.Stop();
            }
            else
            {
                if (Power_Calibration_Controls.Step > Power_Calibration_Controls.STEP_MAX)
                {
                    Proficio_Calibrate_timer.Enabled = false;
                    Proficio_Calibrate_timer.Stop();
                    XCRV_Power_Display_label33.Text = "POWER OUTPUT: " +
                    Convert.ToString(Power_Calibration_Controls.Calibration_Power_Watts)
                                            + "." + Power_Calibration_Controls.Calibration_Power_Watts_Decimal.ToString("D2");
                    Set_Button_Color(false, Proficio_Calibrate_button8);
                    powerrestorebutton2.Enabled = true;
                    Power_Calibration_Controls.Tuning_Mode = false;
                    oCode.SendCommand(txsocket, txtarget, Power_Calibration_Controls.CMD_CALIBRATION_TUNE, 0);
                    ...
                    Master_Controls.Transmit_Mode = false;
                    Power_Calibration_Controls.Calibrating = false;
                    Proficio_Calibrate_button8.Text = "LOW";
                    Proficio_Set_Band_Calibrated(1, (short)Power_Calibration_Controls.Band);
                    MessageBox.Show("COULD NOT ACHIEVE 5 WATTS FOR THIS BAND.", "MSCC",
                          MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                }
            }
            Power_Calibration_Controls.Step++;
            oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_BAND_POWER_POWER,
                               (short)Power_Calibration_Controls.Step);
            powerlabel14.Text = "CALIBRATION STEP: " + Convert.ToString(Power_Calibration_Controls.Step);
        }
        private void Proficio_Calibrate_button8_Click(object sender, EventArgs e)
        {
            MonitorTextBoxText(" Proficio_Calibrate_button8_Click Entered ");
            if (!Master_Controls.Transceiver_Warming)
            {
                if (Power_Calibration_Controls.Band_Is_Selected)
                {
                    if (Power_Calibration_Controls.Warning_Accepted)
                    {
                        ...
                        {
                            Power_Calibration_Controls.Tuning_Mode = true;
                            Power_Calibration_Controls.First_Pass = true;
                            Power_Calibration_Controls.Step = Power_Calibration_Controls.STEP_START;
                            oCode.SendCommand(txsocket, txtarget, Power_Calibration_Controls.CMD_CALIBRATION_TUNE, 1);
                            oCode.SendCommand(txsocket, txtarget, oCode.CMD_SET_BAND_POWER_POWER,
                                                                            (short)Power_Calibration_Controls.Step);
                            Set_Button_Color(true, powertunebutton1);
                            powertunebutton1.Enabled = false;
                            Master_Controls.Transmit_Mode = true;
                            Proficio_Pwr_groupBox6.Enabled = false;
                            //Proficio_Calibrate_button8.Text = "CALIBRATING";
                            Set_Button_Color(true, Proficio_Calibrate_button8,"CALIBRATING");
                            powerrestorebutton2.Enabled = false;
                            Power_Calibration_Controls.Calibration_Power_Watts = 0;
                            Power_Calibration_Controls.Calibration_Power_Watts_Decimal = 0;
                            Power_Calibration_Controls.Calibrating = true;
                            Proficio_Set_Band_Calibrated(0, (short)Power_Calibration_Controls.Band);
                            Thread.Sleep(100);
                            Proficio_Calibrate_timer.Enabled = true;
                            Proficio_Calibrate_timer.Start();
                        }
                        else
                        {
                            Proficio_Calibrate_timer.Enabled = false;
                            Proficio_Calibrate_timer.Stop();
                            Power_Calibration_Controls.Tuning_Mode = false;
                            Power_Calibration_Controls.First_Pass = false;
                            oCode.SendCommand(txsocket, txtarget, Power_Calibration_Controls.CMD_CALIBRATION_TUNE, 0);
                            Set_Button_Color(false, powertunebutton1);
                            powerrestorebutton2.Enabled = true;
                            Master_Controls.Transmit_Mode = false;
                            Proficio_Pwr_groupBox6.Enabled = true;
                            //Proficio_Calibrate_button8.Text = "CALIBRATE";
                            Set_Button_Color(false, Proficio_Calibrate_button8,"CALIBRATE");
                            powerrestorebutton2.Enabled = true;
                            Power_Calibration_Controls.Step = Power_Calibration_Controls.STEP_START;
                            Proficio_Set_Band_Calibrated(0, (short)Power_Calibration_Controls.Band);
                            Power_Calibration_Controls.Calibration_Power_Watts = 0;
                            ...
                            if (Power_Calibration_Controls.Calibrating == true)
                            {
                                MessageBox.Show("CALIBRATION TERMINATED BY USER. THE CURRENT BAND IS NOT CALIBRATED", "MSCC", MessageBoxButtons.OK,
                                    MessageBoxIcon.Asterisk);
                                Power_Calibration_Controls.Calibrating = false;
                            }
                        }
            ...
            MonitorTextBoxText(" Proficio_Calibrate_button8_Click finished ");
        }
        private void Proficio_Check_Band_Calibration()
        {
            if (Power_Calibration_Controls.Calibrated_Bands.B_160 == 1)
            {
                Proficio_Band_Calibrated_160_button.BackColor = Color.Red;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_80 == 1)
            {
                Proficio_Band_Calibrated_80_button.BackColor = Color.Red;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_60 == 1)
            {
                Proficio_Band_Calibrated_60_button.BackColor = Color.Red;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_40 == 1)
            {
                Proficio_Band_Calibrated_40_button.BackColor = Color.Red;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_30 == 1)
            {
                Proficio_Band_Calibrated_30_button.BackColor = Color.Red;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_20 == 1)
            {
                Proficio_Band_Calibrated_20_button.BackColor = Color.Red;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_17 == 1)
            {
                Proficio_Band_Calibrated_17_button.BackColor = Color.Red;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_15 == 1)
            {
                Proficio_Band_Calibrated_15_button.BackColor = Color.Red;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_12 == 1)
            {
                Proficio_Band_Calibrated_12_button.BackColor = Color.Red;
            }
            if (Power_Calibration_Controls.Calibrated_Bands.B_10 == 1)
            {
                Proficio_Band_Calibrated_10_button.BackColor = Color.Red;
            }
        }
        private void Proficio_Set_Band_Calibrated(short calibrated,short band)
        {
            ...
            {
                case 160:
                    Power_Calibration_Controls.Calibrated_Bands.B_160 = (byte)calibrated;
                    Proficio_Band_Calibrated_160_button.BackColor = indicator_color;
                    break;
                case 80:
                    Power_Calibration_Controls.Calibrated_Bands.B_80 = (byte)calibrated;
                    Proficio_Band_Calibrated_80_button.BackColor = indicator_color;
                    break;
                case 60:
                    Power_Calibration_Controls.Calibrated_Bands.B_60 = (byte)calibrated;
                    Proficio_Band_Calibrated_60_button.BackColor = indicator_color;
                    break;
                case 40:
                    Power_Calibration_Controls.Calibrated_Bands.B_40 = (byte)calibrated;
                    Proficio_Band_Calibrated_40_button.BackColor = indicator_color;
                    break;
                case 30:
                    Power_Calibration_Controls.Calibrated_Bands.B_30 = (byte)calibrated;
                    Proficio_Band_Calibrated_30_button.BackColor = indicator_color;
                    break;
                case 20:
                    Power_Calibration_Controls.Calibrated_Bands.B_20 = (byte)calibrated;
                    Proficio_Band_Calibrated_20_button.BackColor = indicator_color;
                    break;
                case 17:
                    Power_Calibration_Controls.Calibrated_Bands.B_17 = (byte)calibrated;
                    Proficio_Band_Calibrated_17_button.BackColor = indicator_color;
                    break;
                case 15:
                    Power_Calibration_Controls.Calibrated_Bands.B_15 = (byte)calibrated;
                    Proficio_Band_Calibrated_15_button.BackColor = indicator_color;
                    break;
                case 12:
                    Power_Calibration_Controls.Calibrated_Bands.B_12 = (byte)calibrated;
                    Proficio_Band_Calibrated_12_button.BackColor = indicator_color;
                    break;
                case 10:
                    Power_Calibration_Controls.Calibrated_Bands.B_10 = (byte)calibrated;
                    Proficio_Band_Calibrated_10_button.BackColor = indicator_color;
                    break;
            }
        }
        #region 
        ...
        private void Proficio_Band_Calibrated_80_Click(object sender, EventArgs e)
        {
        ...
        private void Proficio_Band_Calibrated_60_button_Click(object sender, EventArgs e)
        {

        }
        private void Proficio_Band_Calibrated_40_button_Click(object sender, EventArgs e)
        {
        ...
        private void Proficio_Band_Calibrated_30_button_Click(object sender, EventArgs e)
        {
        ...
        private void Proficio_Band_Calibrated_20_button_Click(object sender, EventArgs e)
        {
        ...
        private void Proficio_Band_Calibrated_17_button_Click(object sender, EventArgs e)
        {
        ...
        private void Proficio_Band_Calibrated_15_button_Click(object sender, EventArgs e)
        {
        ...
        private void Proficio_Band_Calibrated_12_button_Click(object sender, EventArgs e)
        {
        ...
        private void Proficio_Band_Calibrated_160_button_Click(object sender, EventArgs e)
        {
        ...
        private void Waterfall_button8_Click(object sender, EventArgs e)
        {

        }
        private void Digital_Volume_Attn_button5_Click(object sender, EventArgs e)
        {
            Solidus_Settings.Volume_Settings.Digital_Volume_ATTN_index++;
            if (Solidus_Settings.Volume_Settings.Digital_Volume_ATTN_index > 5)
            {
                Solidus_Settings.Volume_Settings.Digital_Volume_ATTN_index = 0;
            }
            Digital_Volume_Attn_button5.Text = Convert.ToString(Solidus_Settings.Volume_Settings.Digital_Volume_ATTN_index);
            if (Solidus_Settings.Volume_Settings.Mic_Is_Digital)
            {
                oCode.SendCommand(txsocket, txtarget, Volume_Controls.CMD_SET_VOLUME_ATTN,
                    (short)Solidus_Settings.Volume_Settings.Digital_Volume_ATTN_index);
