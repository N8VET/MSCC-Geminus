...
namespace OmniaGUI
{
    public partial class panadapter_control : Form
    {
        ...
        public panadapter_control()
        {
            ...
            Direction_checkBox1.Enabled = true;
            //this.Location = Main_form.Main_location;
        }
        public void Log_Write_Error(Exception e)
        {
            MessageBox.Show("Panadapter-control -> Logging Error -> Log File Write FAILED" + Convert.ToString(e), "MSCC",
        ...
        public bool Init_User_values()
        {
            ...
            {
                temp_string = getBetween(line, "WATERFALL_GRID=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Window_controls.Waterfall_Controls.Time_grid = (byte)temp_int;
                ...
                temp_string = getBetween(line, "WATERFALL_GAIN=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Message = " WATERFALL_GAIN: " + Convert.ToString(temp_int);
                    Write_Debug_Message(Message);
                    Window_controls.Waterfall_Controls.gain = temp_int;
                    Waterfall_Gain_hScrollBar1.Value = Window_controls.Waterfall_Controls.gain;
                }

                temp_string = getBetween(line, "WATERFALL_ZERO=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Message = " WATERFALL_ZERO: " + Convert.ToString(temp_int);
                    Write_Debug_Message(Message);
                    Window_controls.Waterfall_Controls.zero = (byte)temp_int;
                    Waterfall_zero_hScrollBar1.Value = Window_controls.Waterfall_Controls.zero;
                }

                temp_string = getBetween(line, "WATERFALL_SPEED=", ";");
                if (temp_string != "")
                {
                    Int16.TryParse(temp_string, out temp_int);
                    Window_controls.Waterfall_Controls.window_speed = (byte)temp_int;
            ...
            Spectrum_Waterfall_numericUpDown1.Value = refresh_value;
            Panadapter_Controls.Refresh_Index = (byte)refresh_value;
            Refresh_button.Text = Convert.ToString(refresh_value);
            ...
            if (!code_triggered)
            {
                ...
                switch (index)
                {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Panadapter_Controls.Panadapter_Colors.Fill_Color = Color.White;
                        break;
                    case 5:
                        Panadapter_Controls.Panadapter_Colors.Fill_Color = Color.Black;
                        break;
        ...
        private void Panadapter_Grid_checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (!Panadapter_Controls.view_grid)
            {
                ...
                oCode.SendCommand(Panadapter_Controls.txsocket, Panadapter_Controls.txtarget,
                    Panadapter_Controls.CMD_SET_SPECTRUM_VIEW_GRID, 1);
            }
            else
            {
                Panadapter_Controls.view_grid = false;
                oCode.SendCommand(Panadapter_Controls.txsocket, Panadapter_Controls.txtarget,
                  Panadapter_Controls.CMD_SET_SPECTRUM_VIEW_GRID, 0);
            }
        }
        ...
        /*public bool Update_Control_values()
        {
            ...
            // add our folder and file name
#if RPI
            path += "/mscc-MKII/user_controls.ini";
#else
            ...
            Panadapter_Controls.Smoothing_Index = (byte)average_value;
            Panadapter_Smooth_ListBox1.SelectedIndex = Panadapter_Controls.Smoothing_Index;
            Spectrum_Waterfall_numericUpDown1.Value = refresh;
        ...
        */
        ...
        /*private void Line_Alias_checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (Panadapter_Controls.Anti_Alias)
            {
                ...
                oCode.SendCommand(Panadapter_Controls.txsocket, Panadapter_Controls.txtarget,
                    Panadapter_Controls.CMD_SET_SPECTRUM_SHARP, 0);
            }
            else
            {
                Panadapter_Controls.Anti_Alias = true;
                oCode.SendCommand(Panadapter_Controls.txsocket, Panadapter_Controls.txtarget,
                    Panadapter_Controls.CMD_SET_SPECTRUM_SHARP, 1);
            }
        }*/
        ...
        /*private void Refresh_listBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!code_triggered)
            {
                ...
                index++; //Spectrum display needs values from 1 thru 6
                oCode.SendCommand(Panadapter_Controls.txsocket, Panadapter_Controls.txtarget,
        ...
        public void Panadapter_Base_line_hScrollBar1_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            if (!code_triggered)
            {
                ...
                if (value > Panadapter_Base_line_hScrollBar1.Maximum) return;
        ...
        private void Waterfall_Gain_hScrollBar1_Scroll(object sender, ScrollEventArgs e)
        {
            int value = 0;
            //byte[] buf = new byte[2];
            byte[] send_buff = new byte[5];

            value = Waterfall_Gain_hScrollBar1.Value;
            if (value != Window_controls.Waterfall_Controls.gain)
            {
                Window_controls.Waterfall_Controls.gain = Waterfall_Gain_hScrollBar1.Value;
                send_buff[0] = Master_Controls.Extended_Commands.CMD_SET_WATERFALL_GAIN;
                byte[] data = BitConverter.GetBytes(Window_controls.Waterfall_Controls.gain);
                Buffer.BlockCopy(data, 0, send_buff, 1, 4);
                //buf[1] = (byte)Window_controls.Waterfall_Controls.gain;
                oCode.SendCommand_MultiByte(Panadapter_Controls.txsocket, Panadapter_Controls.txtarget,
                      Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND, send_buff, send_buff.Length);
            }
            String Message = " Waterfall Gain: " + Convert.ToString(value);
            Write_Debug_Message(Message);
        }
        private void Waterfall_zero_hScrollBar1_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            value = Waterfall_zero_hScrollBar1.Value;
            if (value != Window_controls.Waterfall_Controls.zero)
            {
                Window_controls.Waterfall_Controls.zero = Waterfall_zero_hScrollBar1.Value;
                send_buff[0] = Master_Controls.Extended_Commands.CMD_SET_WATERFALL_ZERO;
                byte[] data = BitConverter.GetBytes(Window_controls.Waterfall_Controls.zero);
                Buffer.BlockCopy(data, 0, send_buff, 1, 4);
                //buf[1] = (byte)Window_controls.Waterfall_Controls.zero;
                oCode.SendCommand_MultiByte(Panadapter_Controls.txsocket, Panadapter_Controls.txtarget,
                      Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND, send_buff, send_buff.Length);
            }
            String Message = " Waterfall zero: " + Convert.ToString(value);
            Write_Debug_Message(Message);
        }
        //SAVE FOR FUTURE USE
        /*private void Speed_hScrollBar1_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            // value = Speed_hScrollBar1.Value;
            if (value != Window_controls.Waterfall_Controls.window_speed)
            {
                //Window_controls.Waterfall_Controls.window_speed = Speed_hScrollBar1.Value;
                buf[0] = Master_Controls.Extended_Commands.CMD_SET_WATERFALL_SPEED;
                buf[1] = (byte)Window_controls.Waterfall_Controls.window_speed;
                oCode.SendCommand_MultiByte(Panadapter_Controls.txsocket, Panadapter_Controls.txtarget,
                        Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND, buf, buf.Length);
            }
            String Message = " Waterfall speed: " + Convert.ToString(value);
            Write_Debug_Message(Message);
        }*/
        ...
        private void Time_Grid_button1_Click(object sender, EventArgs e)
        {
            ...
            if (Master_Controls.isLoading) return;
            Window_controls.Waterfall_Controls.Time_grid++;
            if (Window_controls.Waterfall_Controls.Time_grid >= 6)
            {
                Window_controls.Waterfall_Controls.Time_grid = 0;
            }
            Time_Grid_button1.Text = Convert.ToString(Window_controls.Waterfall_Controls.Time_grid);
            buf[1] = (byte)Window_controls.Waterfall_Controls.Time_grid;
            oCode.SendCommand_MultiByte(Panadapter_Controls.txsocket, Panadapter_Controls.txtarget,
                    Master_Controls.Extended_Commands.CMD_SET_EXTENDED_COMMAND, buf, buf.Length);
        }
        private void Spectrum_Waterfall_numericUpDown1_ValueChanged(object sender, EventArgs e)
        {
            int index = 0;
            if (Master_Controls.isLoading) return;
            if (!code_triggered)
            {
                index = (int)Spectrum_Waterfall_numericUpDown1.Value;
                Panadapter_Controls.Refresh_Index = (byte)index;
                oCode.SendCommand(Panadapter_Controls.txsocket, Panadapter_Controls.txtarget,
                    Panadapter_Controls.CMD_GET_SET_PANADAPTER_REFRESH, (byte)index);
            }
        ...
        private void Refresh_button_Click(object sender, EventArgs e)
        {
            ...
            if (!code_triggered)
            {
                Panadapter_Controls.Refresh_Index++;
                if (Panadapter_Controls.Refresh_Index >= 9)
                {
                    Panadapter_Controls.Refresh_Index = 1;
                }
                Refresh_button.Text = Convert.ToString(Panadapter_Controls.Refresh_Index); ;
                oCode.SendCommand(Panadapter_Controls.txsocket, Panadapter_Controls.txtarget,
                    Panadapter_Controls.CMD_GET_SET_PANADAPTER_REFRESH, Panadapter_Controls.Refresh_Index);
            }
        }

        private void Gain_label_Click(object sender, EventArgs e)
        {
