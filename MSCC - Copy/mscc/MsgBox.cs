...
namespace xDialog
{
    class MsgBox : Form
    {
        ...
        {
            if (Master_Controls.popup_button_config == 0)
            {
                Button btnYes = new Button();
                btnYes.Text = "COARSE";
                btnYes.Click += ButtonClick;
        ...
        private void InitializeComponent()
        {
            ...
            this.ClientSize = new System.Drawing.Size(284, 261);
            this.Name = "MsgBox";
            this.Load += new System.EventHandler(this.MsgBox_Load_1);
            this.ResumeLayout(false);

        }

        private void MsgBox_Load_1(object sender, EventArgs e)
        {
        ...
        /*private void InitializeComponent()
        {
            ...
            this.ClientSize = new System.Drawing.Size(284, 261);
            this.Name = "MsgBox";
            this.Load += new System.EventHandler(this.MsgBox_Load_2);
            this.ResumeLayout(false);

        }*/

        /*private void MsgBox_Load_2(object sender, EventArgs e)
        {
